...
type TestFplValueScopeFplId() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base9" -> Assert.AreEqual<string>(varVal, base1.FplId)
            ...
            | "base15" -> Assert.AreEqual<string>("-(x)", base1.FplId)
            | "base15a" -> Assert.AreEqual<string>("'(x)", base1.FplId)
            | "base15b" -> Assert.AreEqual<string>("'(-(x))", base1.FplId)
            | "base16" -> Assert.AreEqual<string>("-(+(y, =(x, *(2, x))))", base1.FplId)
            | "base17" -> Assert.AreEqual<string>("'(+(y, =('(x), *(2, x))))", base1.FplId)
            | "base18" -> Assert.AreEqual<string>(varVal, base1.FplId)
            | "base19" -> Assert.AreEqual<string>(varVal, base1.FplId)
            | "base20" -> Assert.AreEqual<string>(varVal, base1.FplId)
