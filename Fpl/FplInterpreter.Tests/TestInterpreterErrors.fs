...
type TestInterpreterErrors() =
    ...
    [<DataRow("08a_0", "theorem TestId {dec ~x:ind; true}       proof       TestId$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08b_0", "theorem TestId {dec ~x: ind; true}      proof       TestId$1 { 1. |- trivial };", 0)>]
    [<DataRow("08c_0", "theorem TestId {dec ~x:ind; true}       proof       TestId$1 { 1. |- trivial };", 0)>]
    [<DataRow("08d_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08e_0", "theorem TestId {dec ~x:ind; true}       corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08f_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 { true };", 0)>]
    [<DataRow("08g_0", "theorem TestId {dec ~x:ind; true}       corollary   TestId$1 { true };", 0)>]
    [<DataRow("08h_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08i_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 { true }   proof       TestId$1$1 { dec ~x:obj; 1. |- trivial } ;", 1)>]
    [<DataRow("08j_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 { true }   corollary   TestId$1$1 { dec ~x:obj; true } ;", 1)>]
    [<DataRow("08k_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 { true }   corollary   TestId$1$1 {dec ~x:obj; true } ;", 1)>]
    [<DataRow("08l_0", "theorem TestId {dec ~x:ind; true}       corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08m_0", "theorem TestId {dec ~x: ind; true}      corollary   TestId$1 { true };", 0)>]
    [<DataRow("08n_0", "theorem TestId {dec ~x:ind; true}       corollary   TestId$1 { true };", 0)>]
    [<DataRow("08o_0", "theorem TestId {dec ~x: ind; true}      proof       TestId$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08a_1", "lemma TestId {dec ~x:ind; true}         proof       TestId$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08b_1", "lemma TestId {dec ~x: ind; true}        proof       TestId$1 { 1. |- trivial };", 0)>]
    [<DataRow("08c_1", "lemma TestId {dec ~x:ind; true}         proof       TestId$1 { 1. |- trivial };", 0)>]
    [<DataRow("08d_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08e_1", "lemma TestId {dec ~x:ind; true}         corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08f_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 { true };", 0)>]
    [<DataRow("08g_1", "lemma TestId {dec ~x:ind; true}         corollary   TestId$1 { true };", 0)>]
    [<DataRow("08h_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08i_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 { true }   proof       TestId$1$1 { dec ~x:obj; 1. |- trivial } ;", 1)>]
    [<DataRow("08j_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 { true }   corollary   TestId$1$1 { dec ~x:obj; true } ;", 1)>]
    [<DataRow("08k_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 { true }   corollary   TestId$1$1 {dec ~x:obj; true } ;", 1)>]
    [<DataRow("08l_1", "lemma TestId {dec ~x:ind; true}         corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08m_1", "lemma TestId {dec ~x: ind; true}        corollary   TestId$1 { true };", 0)>]
    [<DataRow("08n_1", "lemma TestId {dec ~x:ind; true}         corollary   TestId$1 { true };", 0)>]
    [<DataRow("08o_1", "lemma TestId {dec ~x: ind; true}        proof       TestId$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08a_2", "proposition TestId {dec ~x:ind; true}   proof       TestId$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08b_2", "proposition TestId {dec ~x: ind; true}  proof       TestId$1 { 1. |- trivial };", 0)>]
    [<DataRow("08c_2", "proposition TestId {dec ~x:ind; true}   proof       TestId$1 { 1. |- trivial };", 0)>]
    [<DataRow("08d_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08e_2", "proposition TestId {dec ~x:ind; true}   corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08f_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 { true };", 0)>]
    [<DataRow("08g_2", "proposition TestId {dec ~x:ind; true}   corollary   TestId$1 { true };", 0)>]
    [<DataRow("08h_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08i_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 { true }   proof       TestId$1$1 { dec ~x:obj; 1. |- trivial } ;", 1)>]
    [<DataRow("08j_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 { true }   corollary   TestId$1$1 { dec ~x:obj; true } ;", 1)>]
    [<DataRow("08k_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 { true }   corollary   TestId$1$1 {dec ~x:obj; true } ;", 1)>]
    [<DataRow("08l_2", "proposition TestId {dec ~x:ind; true}   corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08m_2", "proposition TestId {dec ~x: ind; true}  corollary   TestId$1 { true };", 0)>]
    [<DataRow("08n_2", "proposition TestId {dec ~x:ind; true}   corollary   TestId$1 { true };", 0)>]
    [<DataRow("08o_2", "proposition TestId {dec ~x: ind; true}  proof       TestId$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08a_3", "corollary TestId$1 {dec ~x:ind; true}   proof       TestId$1$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    [<DataRow("08b_3", "corollary TestId$1 {dec ~x: ind; true}  proof       TestId$1$1 { 1. |- trivial };", 0)>]
    [<DataRow("08c_3", "corollary TestId$1 {dec ~x:ind; true}   proof       TestId$1$1 { 1. |- trivial };", 0)>]
    [<DataRow("08d_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08e_3", "corollary TestId$1 {dec ~x:ind; true}   corollary   TestId$1$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08f_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 { true };", 0)>]
    [<DataRow("08g_3", "corollary TestId$1 {dec ~x:ind; true}   corollary   TestId$1$1 { true };", 0)>]
    [<DataRow("08h_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08i_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 { true } proof       TestId$1$1$1 { dec ~x:obj; 1. |- trivial } ;", 1)>]
    [<DataRow("08j_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 { true } corollary   TestId$1$1$1 { dec ~x:obj; true } ;", 1)>]
    [<DataRow("08k_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 { true } corollary   TestId$1$1$1 {dec ~x:obj; true } ;", 1)>]
    [<DataRow("08l_3", "corollary TestId$1 {dec ~x:ind; true}   corollary   TestId$1$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08m_3", "corollary TestId$1 {dec ~x: ind; true}  corollary   TestId$1$1 { true };", 0)>]
    [<DataRow("08n_3", "corollary TestId$1 {dec ~x:ind; true}   corollary   TestId$1$1 { true };", 0)>]
    [<DataRow("08o_3", "corollary TestId$1 {dec ~x: ind; true}  proof       TestId$1$1 { dec ~x:obj; 1. |- trivial };", 1)>]
    
    [<DataRow("08d_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08e_4", "conjecture TestId  {dec ~x:ind; true}   corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08f_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 { true };", 0)>]
    [<DataRow("08g_4", "conjecture TestId  {dec ~x:ind; true}   corollary   TestId$1 { true };", 0)>]
    [<DataRow("08h_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08i_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 { true } proof       TestId$1$1 { dec ~x:obj; 1. |- trivial } ;", 1)>]
    [<DataRow("08j_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 { true } corollary   TestId$1$1 { dec ~x:obj; true } ;", 1)>]
    [<DataRow("08k_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 { true } corollary   TestId$1$1 {dec ~x:obj; true } ;", 1)>]
    [<DataRow("08l_4", "conjecture TestId  {dec ~x:ind; true}   corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08m_4", "conjecture TestId  {dec ~x: ind; true}  corollary   TestId$1 { true };", 0)>]
    [<DataRow("08n_4", "conjecture TestId  {dec ~x:ind; true}   corollary   TestId$1 { true };", 0)>]

    [<DataRow("08d_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08e_5", "axiom      TestId  {dec ~x:ind; true}   corollary   TestId$1 { dec ~x:obj; true };", 1)>]
    [<DataRow("08f_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 { true };", 0)>]
    [<DataRow("08g_5", "axiom      TestId  {dec ~x:ind; true}   corollary   TestId$1 { true };", 0)>]
    [<DataRow("08h_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08i_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 { true } proof       TestId$1$1 { dec ~x:obj; 1. |- trivial } ;", 1)>]
    [<DataRow("08j_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 { true } corollary   TestId$1$1 { dec ~x:obj; true } ;", 1)>]
    [<DataRow("08k_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 { true } corollary   TestId$1$1 {dec ~x:obj; true } ;", 1)>]
    [<DataRow("08l_5", "axiom      TestId  {dec ~x:ind; true}   corollary   TestId$1 {dec ~x:obj; true };", 1)>]
    [<DataRow("08m_5", "axiom      TestId  {dec ~x: ind; true}  corollary   TestId$1 { true };", 0)>]
    [<DataRow("08n_5", "axiom      TestId  {dec ~x:ind; true}   corollary   TestId$1 { true };", 0)>]
    ...
    [<DataRow("0a", "def cl A:obj {intr} thm T {true} proof T$1 {1. bydef A |- trivial };", 0)>]
    [<DataRow("0b", "def pred A() {intr} thm T {true} proof T$1 {1. bydef A |- trivial };", 0)>]
    [<DataRow("0c", "def func A()->obj {intr} thm T {true} proof T$1 {1. bydef A |- trivial };", 0)>]
    ...
    [<DataRow("1g", "proof A$1 {1. |- trivial } thm T {true} proof T$1 {1. bydef A$1 |- trivial };", 1)>]
    [<DataRow("1h", "proof A$1 {1. |- trivial } thm T {true} proof T$1 {1. bydef A$1:2 |- trivial };", 1)>]
    [<DataRow("1i", "proof A$1 {1. |- trivial } thm T {true} proof T$1 {1. bydef A$1:1 |- trivial };", 1)>]
    [<DataRow("1g_", "thm A {true} proof A$1 {1. |- trivial } thm T {true} proof T$1 {1. bydef A$1 |- trivial };", 1)>]
    [<DataRow("1h_", "thm A {true} proof A$1 {1. |- trivial } thm T {true} proof T$1 {1. bydef A$1:2 |- trivial };", 1)>]
    [<DataRow("1i_", "thm A {true} proof A$1 {1. |- trivial } thm T {true} proof T$1 {1. bydef A$1:1 |- trivial };", 1)>]
    [<DataRow("1j", "inf A {pre: true con: true} thm T {true} proof T$1 {1. bydef A |- trivial };", 1)>]
    [<DataRow("99", "uses Fpl.Commons.Structures ;", 0)>]
    [<TestMethod>]
    member this.TestPR000(no:string, fplCode:string, expected) =
        if TestConfig.OfflineMode && fplCode.StartsWith("uses Fpl.") then 
            ()
        else
            let code = PR000 ""
    ...
    [<DataRow("2d", "ax A {true} thm T {true} proof T$1 {1. A |- trivial };", 0)>]
    [<DataRow("2e", "conj A {true} thm T {true} proof T$1 {1. A |- trivial };", 1)>]
    [<DataRow("2f", "thm A {true} thm T {true} proof T$1 {1. A |- trivial };", 0)>]
    ...
    [<DataRow("3j", "cor A$1 {true} thm T {true} proof T$1 {1. A$1 |- trivial };", 0)>]
    [<DataRow("3j_", "thm A {true} cor A$1 {true} thm T {true} proof T$1 {1. A$1 |- trivial };", 0)>]
