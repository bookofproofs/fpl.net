...
type TestFplBlockType() =
    ...
    member this.TestBlockTypeShortName(var) =
        ...
        | "MandatoryFunctionalTerm" -> Assert.AreEqual<string>("mfunc",FplValueType.MandatoryFunctionalTerm.ShortName)
        | "OptionalFunctionalTerm" -> Assert.AreEqual<string>("ofunc",FplValueType.OptionalFunctionalTerm.ShortName)
        | "MandatoryPredicate" -> Assert.AreEqual<string>("mpred",FplValueType.MandatoryPredicate.ShortName)
        | "OptionalPredicate" -> Assert.AreEqual<string>("opred",FplValueType.OptionalPredicate.ShortName)
