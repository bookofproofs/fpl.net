    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base6" -> 
                ...
                Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName arg.Value)
            ...
            | "base11a" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            ...
            | "base11b" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            ...
            | "base11c" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            ...
            | "base11d" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            ...
            | "base11e" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            ...
            | "base10f" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            | "base11f" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
            ...
            | "base21" -> Assert.AreEqual<string>("TestPredicateQualifiedName.T1()." + varVal, qualifiedName base1)
