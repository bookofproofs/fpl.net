...
type TestFplValueScopeQualifiedName() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base11a" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().x", qualifiedName base1 false) 
            | "base12a" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().x", qualifiedName base1 false) 
            ...
            | "base13d" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().1[y]", qualifiedName base1 false) 
            | "base10e" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().parent[a, b]", qualifiedName base1 false) 
            | "base11e" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().x[a, b]", qualifiedName base1 false) 
            | "base12e" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().3[a, b]", qualifiedName base1 false) 
            | "base13e" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().T[a, b]", qualifiedName base1 false) 
            | "base10f" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().x(a, b)", qualifiedName base1 false) 
            | "base11f" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().x(a, b)", qualifiedName base1 false) 
            | "base12f" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().parent(a, b)", qualifiedName base1 false) 
            | "base13f" -> Assert.AreEqual<string>("a reference TestPredicateQualifiedName.T1().T(a, b)", qualifiedName base1 false) 
