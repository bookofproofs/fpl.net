...
type TestFplValueScopeQualifiedName() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base2" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base3" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base4" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base5" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base6" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base7" -> Assert.AreEqual("Test.T1().bydef.Test()", base1.QualifiedName)
            | "base8" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base9" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base10" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base13" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11a" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12a" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base10b" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11b" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12b" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base13b" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base10c" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11c" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12c" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base13c" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base10d" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11d" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12d" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base13d" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base10e" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11e" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12e" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base13e" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base10f" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base11f" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base12f" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base13f" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base14" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base15" -> Assert.AreEqual("Test.T1().-(x)", base1.QualifiedName)
            | "base15a" -> Assert.AreEqual("Test.T1().'(x)", base1.QualifiedName)
            | "base15b" -> Assert.AreEqual("Test.T1().'(-(x))", base1.QualifiedName)
            | "base16" -> Assert.AreEqual("Test.T1().-(+(y, =(x, *(2, x))))", base1.QualifiedName)
            | "base17" -> Assert.AreEqual("Test.T1().'(+(y, =('(x), *(2, x))))", base1.QualifiedName)
            | "base18" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base19" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base20" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base21" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base21a" -> Assert.AreEqual("Test.T1().not x", base1.QualifiedName)
            | "base21b" -> Assert.AreEqual("Test.T1().not x", base1.QualifiedName)
            | "base22" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base23" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base24" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base25" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base26" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base27" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base28" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base29" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base30" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base31" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | "base32" -> Assert.AreEqual("Test.T1()." + varVal, base1.QualifiedName)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestCallConstructorParentClass(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual("Test.A.A(T1, func, ind, pred).bas.B()", base1.QualifiedName)
            | "base2" -> Assert.AreEqual("Test.A.A(T1, func, ind, pred).bas.C(a, b, c, d)", base1.QualifiedName)
            | "base3" -> Assert.AreEqual("Test.A.A(T1, func, ind, pred).bas.D(self, a, b)", base1.QualifiedName)
            | "base4" -> Assert.AreEqual("Test.A.A(T1, func, ind, pred).bas.B(In(x))", base1.QualifiedName)
            | "base5" -> Assert.AreEqual("Test.A.A(T1, func, ind, pred).bas.C(Test1(a), Test2(b, c, d))", base1.QualifiedName)
            | "base6" -> Assert.AreEqual("Test.A.A(T1, func, ind, pred).bas.E(true, undef, false)", base1.QualifiedName)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual("Test.T1().del.B()", base1.QualifiedName)
            | "base2" -> Assert.AreEqual("Test.T1().del.C(a, b, c, d)", base1.QualifiedName)
            | "base3" -> Assert.AreEqual("Test.T1().del.D(self, b, c)", base1.QualifiedName)
            | "base4" -> Assert.AreEqual("Test.T1().del.B(In(x))", base1.QualifiedName)
            | "base5" -> Assert.AreEqual("Test.T1().del.Test()", base1.QualifiedName)
            | "base6" -> Assert.AreEqual("Test.T1().del.C(Test1(a), Test2(b, c, d))", base1.QualifiedName)
            | "base7" -> Assert.AreEqual("Test.T1().del.E(true, undef, false)", base1.QualifiedName)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual("Test.T1()", base1.QualifiedName)
            | "base2" -> Assert.AreEqual("Test.T1()", base1.QualifiedName)
            | "base3" -> Assert.AreEqual("Test.T1()", base1.QualifiedName)
            | "base4" -> Assert.AreEqual("Test.T1()", base1.QualifiedName)
            | "base5" -> Assert.AreEqual("Test.T1", base1.QualifiedName)
            | "base5a" -> Assert.AreEqual("Test.T1", base1.QualifiedName)
            | "base6" -> Assert.AreEqual("Test.T1() -> obj", base1.QualifiedName)
            | "base7" -> Assert.AreEqual("Test.T1() -> obj", base1.QualifiedName)
            | "base8" -> Assert.AreEqual("Test.T1() -> obj", base1.QualifiedName)
            | "base9" -> Assert.AreEqual("Test.T1() -> obj", base1.QualifiedName)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
