...
type TestInferredExpressionsJust() =
    ...
    [<DataRow("74b", """ax A1 {dec p,q,r:pred; (p ⇔ q) ⩡ r ∧ ¬p} thm T { (∀ x:obj {x is N} ⇔ ∃ y:obj {y is M}) ⩡ (true ∨ false) ∧ ¬∀ z:obj {z is N} } prf T$1 { 1. byax A1 |- (∀ x:obj {x is N} ⇔ ∃ y:obj {y is M}) ⩡ (true ∨ false) ∧ ¬∀ z:obj {z is N} }""", "(∀ x:obj {x is N} ⇔ ∃ y:obj {y is M}) ⩡ ((true ∨ false) ∧ ¬∀ z:obj {z is N})", 2)>]
    ...
    [<DataRow("74i", """ax A1 {dec r:pred; r ∧ r} thm T { ∀ x:obj {x is N} ∧ ∀ z:obj {z is N} } prf T$1 { 1. byax A1 |- ∀ x:obj {x is N} ∧ ∀ z:obj {z is N} }""", "∀ x:obj {x is N} ∧ ∀ z:obj {z is N}", 2)>]
