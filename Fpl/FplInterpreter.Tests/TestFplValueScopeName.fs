...
type TestFplValueScopeName() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base6" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            ...
            | "base13" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base11a" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            ...
            | "base11b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base12b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base13b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base10c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base11c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base12c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base13c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base10d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base11d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base12d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base13d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base10e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base11e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base12e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base13e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base10f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base11f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base12f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            | "base13f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
            ...
            | "base21" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Name))
