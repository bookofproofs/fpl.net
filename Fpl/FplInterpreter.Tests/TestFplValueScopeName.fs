...
type TestFplValueScopeName() =
    ...
    member this.TestVariablesInBlock(var) =
        ...
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "x" -> Assert.AreEqual<string>("x", x.Type(SignatureType.Mixed))
            | "y" -> Assert.AreEqual<string>("y", y.Type(SignatureType.Mixed))
            | "s" -> Assert.AreEqual<string>("s", s.Type(SignatureType.Mixed))
            | "xu" -> Assert.AreEqual<string>("u", xu.Type(SignatureType.Mixed))
            | "xv" -> Assert.AreEqual<string>("v", xv.Type(SignatureType.Mixed))
            | "xw" -> Assert.AreEqual<string>("w", xw.Type(SignatureType.Mixed))
            | "yu" -> Assert.AreEqual<string>("u", yu.Type(SignatureType.Mixed))
            | "yv" -> Assert.AreEqual<string>("v", yv.Type(SignatureType.Mixed))
            | "yw" -> Assert.AreEqual<string>("w", yw.Type(SignatureType.Mixed))
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base2" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base3" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base4" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base5" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base6" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base7" -> Assert.AreEqual<string>("bydef.Test()", base1.Type(SignatureType.Mixed))
            | "base8" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base9" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base10" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base13" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11a" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12a" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base10b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base13b" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base10c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base13c" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base10d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base13d" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base10e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base13e" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base10f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base11f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base12f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base13f" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base14" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base15" -> Assert.AreEqual<string>("-(x)", base1.Type(SignatureType.Mixed))
            | "base15a" -> Assert.AreEqual<string>("'(x)", base1.Type(SignatureType.Mixed))
            | "base15b" -> Assert.AreEqual<string>("'(-(x))", base1.Type(SignatureType.Mixed))
            | "base16" -> Assert.AreEqual<string>("-(+(y, =(x, *(2, x))))", base1.Type(SignatureType.Mixed))
            | "base17" -> Assert.AreEqual<string>("'(+(y, =('(x), *(2, x))))", base1.Type(SignatureType.Mixed))
            | "base18" -> Assert.AreEqual<string>("ex(x(a), y, z)", base1.Type(SignatureType.Mixed))
            | "base19" -> Assert.AreEqual<string>("exn$1(x)", base1.Type(SignatureType.Mixed))
            | "base20" -> Assert.AreEqual<string>("all(x)", base1.Type(SignatureType.Mixed))
            | "base21" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base21a" -> Assert.AreEqual<string>("not(x)", base1.Type(SignatureType.Mixed))
            | "base21b" -> Assert.AreEqual<string>("not(x)", base1.Type(SignatureType.Mixed))
            | "base22" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base23" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base24" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base25" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base26" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base27" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base28" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base29" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base30" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base31" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base32" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | "base33" -> Assert.AreEqual<string>("p(c)", base1.Type(SignatureType.Mixed))
            | "base34" -> Assert.AreEqual<string>(varVal, base1.Type(SignatureType.Mixed))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestLocalization(var, predName, trslCode) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>(predName, pred.Type(SignatureType.Mixed))
            | "base2" -> Assert.AreEqual<string>(predName, pred.Type(SignatureType.Mixed))
            | "base3" -> Assert.AreEqual<string>(predName, pred.Type(SignatureType.Mixed))
            | "base4" -> Assert.AreEqual<string>(predName, pred.Type(SignatureType.Mixed))
            | "base5" -> Assert.AreEqual<string>(predName, pred.Type(SignatureType.Mixed))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
