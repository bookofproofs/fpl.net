...
type TestFplValueScopeName() =
    ...
    member this.TestPredicateName(var, varVal) =
        ...
        | "base18" -> Assert.AreEqual<string>("∃x:pred(obj, T), y:C, z:ind (a ∧ abc(b, c))", base1.Type(SignatureType.Name))
        | "base19" -> Assert.AreEqual<string>("∃!x:obj (∀y:N (true))", base1.Type(SignatureType.Name))
        | "base19a" -> Assert.AreEqual<string>("∃!2x:obj (∃y:N (true))", base1.Type(SignatureType.Name))
        | "base19b" -> Assert.AreEqual<string>("∃!3x:obj (∃!2y:N (true))", base1.Type(SignatureType.Name))
