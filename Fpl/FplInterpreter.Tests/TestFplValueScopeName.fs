...
type TestFplValueScopeName() =
    ...
    member this.TestVariablesInBlockVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "x" -> Assert.AreEqual<string>("x(func(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj, func(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj, func(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj)[ind]", x.Type(SignatureType.Mixed))
            | "y" -> Assert.AreEqual<string>("y(func(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj, func(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj, func(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj)[ind]", y.Type(SignatureType.Mixed))
            | "xu" -> Assert.AreEqual<string>("u(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj", xu.Type(SignatureType.Mixed))
            | "xv" -> Assert.AreEqual<string>("v(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj", xv.Type(SignatureType.Mixed))
            | "xw" -> Assert.AreEqual<string>("w(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj", xw.Type(SignatureType.Mixed))
            | "yu" -> Assert.AreEqual<string>("u(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj", yu.Type(SignatureType.Mixed))
            | "yv" -> Assert.AreEqual<string>("v(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj", yv.Type(SignatureType.Mixed))
            | "yw" -> Assert.AreEqual<string>("w(*obj[tpl], *obj[tpl], *obj[tpl]) -> obj", yw.Type(SignatureType.Mixed))
            | "xua" -> Assert.AreEqual<string>("a[tpl]", xua.Type(SignatureType.Mixed))
            | "xub" -> Assert.AreEqual<string>("b[tpl]", xub.Type(SignatureType.Mixed))
            | "xuc" -> Assert.AreEqual<string>("c[tpl]", xuc.Type(SignatureType.Mixed))
            | "xva" -> Assert.AreEqual<string>("a[tpl]", xva.Type(SignatureType.Mixed))
            | "xvb" -> Assert.AreEqual<string>("b[tpl]", xvb.Type(SignatureType.Mixed))
            | "xvc" -> Assert.AreEqual<string>("c[tpl]", xvc.Type(SignatureType.Mixed))
            | "xwa" -> Assert.AreEqual<string>("a[tpl]", xwa.Type(SignatureType.Mixed))
            | "xwb" -> Assert.AreEqual<string>("b[tpl]", xwb.Type(SignatureType.Mixed))
            | "xwc" -> Assert.AreEqual<string>("c[tpl]", xwc.Type(SignatureType.Mixed))
            | "yua" -> Assert.AreEqual<string>("a[tpl]", yua.Type(SignatureType.Mixed))
            | "yub" -> Assert.AreEqual<string>("b[tpl]", yub.Type(SignatureType.Mixed))
            | "yuc" -> Assert.AreEqual<string>("c[tpl]", yuc.Type(SignatureType.Mixed))
            | "yva" -> Assert.AreEqual<string>("a[tpl]", yva.Type(SignatureType.Mixed))
            | "yvb" -> Assert.AreEqual<string>("b[tpl]", yvb.Type(SignatureType.Mixed))
            | "yvc" -> Assert.AreEqual<string>("c[tpl]", yvc.Type(SignatureType.Mixed))
            | "ywa" -> Assert.AreEqual<string>("a[tpl]", ywa.Type(SignatureType.Mixed))
            | "ywb" -> Assert.AreEqual<string>("b[tpl]", ywb.Type(SignatureType.Mixed))
            | "ywc" -> Assert.AreEqual<string>("c[tpl]", ywc.Type(SignatureType.Mixed))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "block" -> Assert.AreEqual<string>("TestPredicate(*pred(func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj)[obj], *pred(func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj)[obj])", block.Type(SignatureType.Mixed)); 
            | "x" -> Assert.AreEqual<string>("x(func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj)[obj]", x.Type(SignatureType.Mixed))
            | "y" -> Assert.AreEqual<string>("y(func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj)[obj]", y.Type(SignatureType.Mixed))
            | "xu" -> Assert.AreEqual<string>("u(*obj[ind], *obj[ind], *obj[ind]) -> obj", xu.Type(SignatureType.Mixed))
            | "xv" -> Assert.AreEqual<string>("v(*obj[ind], *obj[ind], *obj[ind]) -> obj", xv.Type(SignatureType.Mixed))
            | "xw" -> Assert.AreEqual<string>("w(*obj[ind], *obj[ind], *obj[ind]) -> obj", xw.Type(SignatureType.Mixed))
            | "yu" -> Assert.AreEqual<string>("u(*obj[ind], *obj[ind], *obj[ind]) -> obj", yu.Type(SignatureType.Mixed))
            | "yv" -> Assert.AreEqual<string>("v(*obj[ind], *obj[ind], *obj[ind]) -> obj", yv.Type(SignatureType.Mixed))
            | "yw" -> Assert.AreEqual<string>("w(*obj[ind], *obj[ind], *obj[ind]) -> obj", yw.Type(SignatureType.Mixed))
            | "xua" -> Assert.AreEqual<string>("a[ind]", xua.Type(SignatureType.Mixed))
            | "xub" -> Assert.AreEqual<string>("b[ind]", xub.Type(SignatureType.Mixed))
            | "xuc" -> Assert.AreEqual<string>("c[ind]", xuc.Type(SignatureType.Mixed))
            | "xva" -> Assert.AreEqual<string>("a[ind]", xva.Type(SignatureType.Mixed))
            | "xvb" -> Assert.AreEqual<string>("b[ind]", xvb.Type(SignatureType.Mixed))
            | "xvc" -> Assert.AreEqual<string>("c[ind]", xvc.Type(SignatureType.Mixed))
            | "xwa" -> Assert.AreEqual<string>("a[ind]", xwa.Type(SignatureType.Mixed))
            | "xwb" -> Assert.AreEqual<string>("b[ind]", xwb.Type(SignatureType.Mixed))
            | "xwc" -> Assert.AreEqual<string>("c[ind]", xwc.Type(SignatureType.Mixed))
            | "yua" -> Assert.AreEqual<string>("a[ind]", yua.Type(SignatureType.Mixed))
            | "yub" -> Assert.AreEqual<string>("b[ind]", yub.Type(SignatureType.Mixed))
            | "yuc" -> Assert.AreEqual<string>("c[ind]", yuc.Type(SignatureType.Mixed))
            | "yva" -> Assert.AreEqual<string>("a[ind]", yva.Type(SignatureType.Mixed))
            | "yvb" -> Assert.AreEqual<string>("b[ind]", yvb.Type(SignatureType.Mixed))
            | "yvc" -> Assert.AreEqual<string>("c[ind]", yvc.Type(SignatureType.Mixed))
            | "ywa" -> Assert.AreEqual<string>("a[ind]", ywa.Type(SignatureType.Mixed))
            | "ywb" -> Assert.AreEqual<string>("b[ind]", ywb.Type(SignatureType.Mixed))
            | "ywc" -> Assert.AreEqual<string>("c[ind]", ywc.Type(SignatureType.Mixed))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base11a" -> Assert.AreEqual<string>("x", base1.Type(SignatureType.Name))
            | "base12a" -> Assert.AreEqual<string>("x", base1.Type(SignatureType.Name))
            ...
            | "base11c" -> Assert.AreEqual<string>("v(x, y)", base1.Type(SignatureType.Name))
            ...
            | "base13d" -> Assert.AreEqual<string>("1[y]", base1.Type(SignatureType.Name))
            | "base10e" -> Assert.AreEqual<string>("parent[a, b]", base1.Type(SignatureType.Name))
            | "base11e" -> Assert.AreEqual<string>("x[a, b]", base1.Type(SignatureType.Name))
            | "base12e" -> Assert.AreEqual<string>("3[a, b]", base1.Type(SignatureType.Name))
            | "base13e" -> Assert.AreEqual<string>("T[a, b]", base1.Type(SignatureType.Name))
            | "base10f" -> Assert.AreEqual<string>("x(a, b)", base1.Type(SignatureType.Name))
            | "base11f" -> Assert.AreEqual<string>("x(a, b)", base1.Type(SignatureType.Name))
            | "base12f" -> Assert.AreEqual<string>("parent(a, b)", base1.Type(SignatureType.Name))
            | "base13f" -> Assert.AreEqual<string>("T(a, b)", base1.Type(SignatureType.Name))
    ...
    member this.TestBaseConstructorCall(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base3" -> Assert.AreEqual<string>("D(undef, T1, func)", base1.Type(SignatureType.Mixed))
    ...
    member this.TestDelegateName(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base3" -> Assert.AreEqual<string>("D(undef, ind, ind)", base1.Type(SignatureType.Mixed))
            | "base4" -> Assert.AreEqual<string>("B(In(undef))", base1.Type(SignatureType.Mixed))
    ...
    member this.TestMapping(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base7" -> Assert.AreEqual<string>("pred(*obj[ind])", mapping.Type(SignatureType.Mixed))
            | "base8" -> Assert.AreEqual<string>("func(*pred(obj)[ind]) -> pred(ind)", mapping.Type(SignatureType.Mixed))
            | "base9" -> Assert.AreEqual<string>("pred(*func(A) -> A[ind])", mapping.Type(SignatureType.Mixed))
