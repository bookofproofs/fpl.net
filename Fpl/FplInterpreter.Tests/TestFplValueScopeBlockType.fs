...
type TestFplValueScopeBlockType() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue) -> 
            ...
            | "cla1" -> Assert.AreEqual(FplBlockType.Class ({Inheritance.From = []}), cla1.BlockType)
            | "cla2" -> Assert.AreEqual(FplBlockType.Class ({Inheritance.From = []}), cla2.BlockType)
    ...
    member this.TestConstructors(var) =
        ...
        | Some (r,theory,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue) -> 
            ...
            | "r" -> Assert.AreEqual(FplBlockType.Root, r.BlockType)
            | "theory" -> Assert.AreEqual(FplBlockType.Theory, theory.BlockType)
            | "block" -> Assert.AreEqual(FplBlockType.Class({Inheritance.From = []}), block.BlockType)
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplValue,theory:FplValue,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue,t5:FplValue,t6:FplValue,t7:FplValue,t8:FplValue,t9:FplValue,t10:FplValue,t11:FplValue,t12:FplValue,
            ...
            | "t1" -> Assert.AreEqual(FplBlockType.MandatoryPredicate, t1.BlockType)
            | "t2" -> Assert.AreEqual(FplBlockType.OptionalPredicate, t2.BlockType)
            | "t3" -> Assert.AreEqual(FplBlockType.MandatoryFunctionalTerm, t3.BlockType)
            | "t4" -> Assert.AreEqual(FplBlockType.OptionalFunctionalTerm, t4.BlockType)
            | "t5" -> Assert.AreEqual(FplBlockType.MandatoryFunctionalTerm, t5.BlockType)
            | "t6" -> Assert.AreEqual(FplBlockType.OptionalFunctionalTerm, t6.BlockType)
            | "t7" -> Assert.AreEqual(FplBlockType.MandatoryFunctionalTerm, t7.BlockType)
            | "t8" -> Assert.AreEqual(FplBlockType.OptionalFunctionalTerm, t8.BlockType)
            | "t9" -> Assert.AreEqual(FplBlockType.MandatoryFunctionalTerm, t9.BlockType)
            | "t10" -> Assert.AreEqual(FplBlockType.OptionalFunctionalTerm, t10.BlockType)
            | "t11" -> Assert.AreEqual(FplBlockType.MandatoryFunctionalTerm, t11.BlockType)
            | "t12" -> Assert.AreEqual(FplBlockType.OptionalFunctionalTerm, t12.BlockType)
            | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
