...
type TestFplValueScopeBlockType() =
    ...
    member this.TestMapping(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base2" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base3" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base4" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base5" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base6" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base7" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base8" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base9" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | "base10" -> Assert.AreEqual<FplValueType>(FplValueType.Mapping, mapping.BlockType)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestArgument(var, argExpression, expNumber:int) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<FplValueType>(FplValueType.Argument, arg.BlockType)
            | "base2" -> Assert.AreEqual<FplValueType>(FplValueType.Argument, arg.BlockType)
            | "base3" -> Assert.AreEqual<FplValueType>(FplValueType.Argument, arg.BlockType)
            | "base4" -> Assert.AreEqual<FplValueType>(FplValueType.Argument, arg.BlockType)
            | "base5" -> Assert.AreEqual<FplValueType>(FplValueType.Argument, arg.BlockType)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestLanguage(var, predName, trslCode) =
        ...
        | Some st -> 
            ...
            match var with
            | "base0" -> Assert.AreEqual<FplValueType>(FplValueType.Language, lang.BlockType)
            | "base1" -> Assert.AreEqual<FplValueType>(FplValueType.Language, lang.BlockType)
            | "base2" -> Assert.AreEqual<FplValueType>(FplValueType.Language, lang.BlockType)
            | "base3" -> Assert.AreEqual<FplValueType>(FplValueType.Language, lang.BlockType)
            | "base4" -> Assert.AreEqual<FplValueType>(FplValueType.Language, lang.BlockType)
            | "base5" -> Assert.AreEqual<FplValueType>(FplValueType.Language, lang.BlockType)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestLocalization(var, predName, trslCode) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<FplValueType>(FplValueType.Localization, pred.BlockType)
            | "base2" -> Assert.AreEqual<FplValueType>(FplValueType.Localization, pred.BlockType)
            | "base3" -> Assert.AreEqual<FplValueType>(FplValueType.Localization, pred.BlockType)
            | "base4" -> Assert.AreEqual<FplValueType>(FplValueType.Localization, pred.BlockType)
            | "base5" -> Assert.AreEqual<FplValueType>(FplValueType.Localization, pred.BlockType)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestTranslation(var, predName, trslCode) =
        ...
        | Some st -> 
            ...
            match var with
            | "base0" -> Assert.AreEqual<FplValueType>(FplValueType.Translation, trsl.BlockType)
            | "base1" -> Assert.AreEqual<FplValueType>(FplValueType.Translation, trsl.BlockType)
            | "base2" -> Assert.AreEqual<FplValueType>(FplValueType.Translation, trsl.BlockType)
            | "base3" -> Assert.AreEqual<FplValueType>(FplValueType.Translation, trsl.BlockType)
            | "base4" -> Assert.AreEqual<FplValueType>(FplValueType.Translation, trsl.BlockType)
            | "base5" -> Assert.AreEqual<FplValueType>(FplValueType.Translation, trsl.BlockType)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
