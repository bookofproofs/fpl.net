...
type TestProceedingExpressions() =
    ...
    [<DataRow("MP_01b", "inf M {dec ~p,q: pred; pre: and (p, impl (p,q) ) con: q} thm T {true} proof T$1 {1. |- and(true, xor(true, false)) 2. 1, byinf M |- false};", "true ⩡ false", 1)>]
    ...
    [<DataRow("AndC_02", "inf AndCummutative{dec ~p,q:pred; pre:and(p,q) con:and(q,p)} thm T {true} proof T$1 {1. |- or(true,false) 2. 1, byinf AndCummutative |- and(false,true)};", "false ∧ true", 1)>]
    ...
    [<DataRow("OrC_02", "inf OrCummutative{dec ~p,q:pred; pre:or(p,q) con:or(q,p)} thm T {true} proof T$1 {1. |- and(true,false) 2. 1, byinf OrCummutative |- or(false,true)};", "false ∨ true", 1)>]
    ...
    [<DataRow("IifC_02", "inf IifCummutative{dec ~p,q:pred; pre:iif(p,q) con:iif(q,p)} thm T {true} proof T$1 {1. |- and(true,false) 2. 1, byinf IifCummutative |- iif(false,true)};", "false ⇔ true", 1)>]
    ...
    [<DataRow("AndA_02", "inf AndAssociative{dec ~p,q,s:pred; pre:and(p,and(q,s)) con:and(and(p,q),s)} thm T {true} proof T$1 {1. |- and(and(true,false), true) 2. 1, byinf AndAssociative |- and(and(true,false), true)};", "(true ∧ false) ∧ true", 1)>]
    ...
    [<DataRow("OrA_02", "inf OrAssociative{dec ~p,q,s:pred; pre:or(p,or(q,s)) con:or(or(p,q),s)} thm T {true} proof T$1 {1. |- or(or(true,false), true) 2. 1, byinf OrAssociative |- or(or(true,false), true)};", "(true ∨ false) ∨ true", 1)>]
    ...
    [<DataRow("IifA_02", "inf IifAssociative{dec ~p,q,s:pred; pre:iif(p,iif(q,s)) con:iif(iif(p,q),s)} thm T {true} proof T$1 {1. |- iif(iif(true,false), true) 2. 1, byinf IifAssociative |- iif(iif(true,false), true)};", "(true ⇔ false) ⇔ true", 1)>]
    ...
    [<DataRow("AndOrDistributiveUnpack_03", "inf AndOrDistributiveUnpack{dec ~p,q,s:pred; pre:and(p,or(q,s)) con:or(and(p,q),and(p,s))} thm T {true} proof T$1 {1. |- and(not(xor(true, false)), or(iif(true, false), and(exn$1 z:obj {is(z, N)}, true))) 2. 1, byinf AndOrDistributiveUnpack |- true};", "(¬(true ⩡ false) ∧ (true ⇔ false)) ∨ (¬(true ⩡ false) ∧ ((exn$1 z:obj {z is N}) ∧ true))", 1)>]
    ...
    [<DataRow("AndPack2Iif_01", "inf AndPack2Iif{dec ~p,q:pred; pre:and(or(not p,q),or(p,not q)) con:iif(p,q)} thm T {true} proof T$1 {1. |- and(or(not all x:obj {is(x, N)}, ex y:obj {is(y, M)}), or(all x:obj {is(x, N)}, not ex z:obj {is(z, K)})) 2. 1, byinf AndPack2Iif |- true};", "(((¬(∀ x:obj {x is N})) ∨ (∃ y:obj {y is M})) ∧ ((∀ x:obj {x is N}) ∨ (¬(∃ z:obj {z is K})))) ⇔ true", 1)>]
    [<DataRow("AndPack2Iif_02", "inf AndPack2Iif{dec ~p,q:pred; pre:and(or(not p,q),or(p,not q)) con:iif(p,q)} thm T {true} proof T$1 {1. |- and(or(not iif(true, false), xor(true, false)), or(iif(true, false), not xor(true, false))) 2. 1, byinf AndPack2Iif |- true};", "(((¬(true ⇔ false)) ∨ (true ⩡ false)) ∧ ((true ⇔ false) ∨ (¬(true ⩡ false)))) ⇔ true", 1)>]
    [<DataRow("AndPack2Iif_03", "inf AndPack2Iif{dec ~p,q:pred; pre:and(or(not p,q),or(p,not q)) con:iif(p,q)} thm T {true} proof T$1 {1. |- and(or(not (impl(true, false)), and(true, false)), or(impl(true, false), not and(true, false))) 2. 1, byinf AndPack2Iif |- true};", "(((¬(true ⇒ false)) ∨ (true ∧ false)) ∧ ((true ⇒ false) ∨ (¬(true ∧ false)))) ⇔ true", 1)>]
    ...
    [<DataRow("Or2NotXor_01", "inf Or2NotXor{dec ~p,q:pred; pre:or(and(p,q),and(not p,not q)) con:not (xor(p,q))} thm T {true} proof T$1 {1. |- or(and(all x:obj {is(x, N)}, ex y:obj {is(y, M)}), and(not all x:obj {is(x, N)}, not ex y:obj {is(y, M)})) 2. 1, byinf Or2NotXor |- true};", "((∀ x:obj {x is N}) ∧ (∃ y:obj {y is M})) ∨ (¬(∀ x:obj {x is N}) ∧ ¬(∃ y:obj {y is M}))", 1)>]
    [<DataRow("Or2NotXor_02", "inf Or2NotXor{dec ~p,q:pred; pre:or(and(p,q),and(not p,not q)) con:not (xor(p,q))} thm T {true} proof T$1 {1. |- or(and(iif(true, false), xor(true, false)), and(not iif(true, false), not xor(true, false))) 2. 1, byinf Or2NotXor |- true};", "((true ⇔ false) ∧ (true ⩡ false)) ∨ (¬(true ⇔ false) ∧ ¬(true ⩡ false))", 1)>]
    [<DataRow("Or2NotXor_03", "inf Or2NotXor{dec ~p,q:pred; pre:or(and(p,q),and(not p,not q)) con:not (xor(p,q))} thm T {true} proof T$1 {1. |- or(and(impl(true, false), and(true, false)), and(not (impl(true, false)), not (and(true, false)))) 2. 1, byinf Or2NotXor |- true};", "((true ⇒ false) ∧ (true ∧ false)) ∨ (¬(true ⇒ false) ∧ ¬(true ∧ false))", 1)>]
    ...
    [<DataRow("ExNot2NotAll_03", "inf ExNot2NotAll{dec ~p:pred(y:tpl); pre:ex x:tpl{not p(x)} con:not all x:tpl{p(x)}} thm T {true} proof T$1 {1. |- ex y:obj {not (all z:obj {impl(is(z,N), false)})} 2. 1, byinf ExNot2NotAll |- true};", "∃ y:obj {¬(∀ z:obj {(z is N) ⇒ false})}", 1)>]
    ...
    [<DataRow("NotEx2AllNot_03", "inf NotEx2AllNot{dec ~p:pred(y:tpl); pre:not ex x:tpl{p(x)} con:all x:tpl{not p(x)}} thm T {true} proof T$1 {1. |- not ex y:obj {not (ex z:obj {is(z,M)})} 2. 1, byinf NotEx2AllNot |- true};", "¬(∃ y:obj {¬(∃ z:obj {z is M})})", 1)>]
    ...
    [<DataRow("AllNot2ExNot_03", "inf AllNot2ExNot{dec ~p:pred(y:tpl); pre:all x:tpl{not p(x)} con:not ex x:tpl{p(x)}} thm T {true} proof T$1 {1. |- all y:obj {not (ex z:obj {is(z,M)})} 2. 1, byinf AllNot2ExNot |- true};", "¬∃ y:obj {∃ z:obj {z is M}}", 1)>]
    ...
    [<DataRow("ModusTollens_01", "inf ModusTollens{dec ~p,q:pred; pre:not q,impl(p,q) con:not (p)} thm T {true} proof T$1 {1. |- not (iif(true,false)) 2. |- impl(all x:obj {is(x,N)}, iif(true,false)) 3. 1, 2, byinf ModusTollens |- true};", "¬(true ⇔ false)", 1)>]
    [<DataRow("ModusTollens_02", "inf ModusTollens{dec ~p,q:pred; pre:not q,impl(p,q) con:not (p)} thm T {true} proof T$1 {1. |- not ex x:obj {is(x,N)} 2. |- impl(xor(true,false), all y:obj {is(y,M)}) 3. 1, 2, byinf ModusTollens |- true};", "¬(∃ x:obj {x is N})", 1)>]
    [<DataRow("ModusTollens_03", "inf ModusTollens{dec ~p,q:pred; pre:not q,impl(p,q) con:not (p)} thm T {true} proof T$1 {1. |- not (and(is(A,N), false)) 2. |- impl(iif(true,false), xor(true,false)) 3. 1, 2, byinf ModusTollens |- true};", "¬((A is N) ∧ false)", 1)>]

    // HypotheticalSyllogism: pre: impl(p,q), impl(q,s)
    [<DataRow("HypotheticalSyllogism_01", "inf HypotheticalSyllogism{dec ~p,q,s:pred; pre:impl(p,q),impl(q,s) con:impl(p,s)} thm T {true} proof T$1 {1. |- impl(all x:obj {is(x,N)}, ex y:obj {is(y,M)}) 2. |- impl(ex z:obj {is(z,M)}, xor(true,false)) 3. 1, 2, byinf HypotheticalSyllogism |- true};", "(∀ x:obj {x is N}) ⇒ (∃ y:obj {y is M})", 1)>]
    [<DataRow("HypotheticalSyllogism_02", "inf HypotheticalSyllogism{dec ~p,q,s:pred; pre:impl(p,q),impl(q,s) con:impl(p,s)} thm T {true} proof T$1 {1. |- impl(iif(true,false), iif(iif(true,false), true)) 2. |- impl(all u:obj {is(u,K)}, iif(true,false)) 3. 1, 2, byinf HypotheticalSyllogism |- true};", "(true ⇔ false) ⇒ ((true ⇔ false) ⇔ true)", 1)>]
    [<DataRow("HypotheticalSyllogism_03", "inf HypotheticalSyllogism{dec ~p,q,s:pred; pre:impl(p,q),impl(q,s) con:impl(p,s)} thm T {true} proof T$1 {1. |- impl(iif(true,false), iif(iif(true,false), true)) 2. |- impl(all u:obj {is(u,K)}, iif(true,false)) 3. 1, 2, byinf HypotheticalSyllogism |- true};", "(true ⇔ false) ⇒ ((true ⇔ false) ⇔ true)", 1)>]
    ...
    [<DataRow("PrenexPackAllAnd_01", "inf PrenexPackAllAnd{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{and(p,q(x))} con:and(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all x:obj {and(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackAllAnd |- true};", "∀ x:obj {(true ⇔ false) ∧ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackAllAnd_02", "inf PrenexPackAllAnd{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{and(p,q(x))} con:and(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all n:Nat {and(ex y:obj {is(y,K)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackAllAnd |- true};", "∀ n:Nat {(∃ y:obj {y is K}) ∧ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackAllAnd_03", "inf PrenexPackAllAnd{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{and(p,q(x))} con:and(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all z:obj {and(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackAllAnd |- true};", "∀ z:obj {¬(true ⩡ false) ∧ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackAllIif: pre: all x:tpl{iif(p, q(x))}
    [<DataRow("PrenexPackAllIif_01", "inf PrenexPackAllIif{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{iif(p,q(x))} con:iif(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all x:obj {iif(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackAllIif |- true};", "∀ x:obj {(true ⇔ false) ⇔ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackAllIif_02", "inf PrenexPackAllIif{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{iif(p,q(x))} con:iif(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all n:Nat {iif(all y:obj {is(y,M)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackAllIif |- true};", "∀ n:Nat {(∀ y:obj {y is M}) ⇔ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackAllIif_03", "inf PrenexPackAllIif{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{iif(p,q(x))} con:iif(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all z:obj {iif(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackAllIif |- true};", "∀ z:obj {¬(true ⩡ false) ⇔ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackAllImpl: pre: all x:tpl{impl(p, q(x))}
    [<DataRow("PrenexPackAllImpl_01", "inf PrenexPackAllImpl{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{impl(p,q(x))} con:impl(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all x:obj {impl(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackAllImpl |- true};", "∀ x:obj {(true ⇔ false) ⇒ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackAllImpl_02", "inf PrenexPackAllImpl{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{impl(p,q(x))} con:impl(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all n:Nat {impl(all y:obj {is(y,M)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackAllImpl |- true};", "∀ n:Nat {(∀ y:obj {y is M}) ⇒ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackAllImpl_03", "inf PrenexPackAllImpl{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{impl(p,q(x))} con:impl(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all z:obj {impl(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackAllImpl |- true};", "∀ z:obj {¬(true ⩡ false) ⇒ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackAllOr: pre: all x:tpl{or(p, q(x))}
    [<DataRow("PrenexPackAllOr_01", "inf PrenexPackAllOr{dec ~p:pred~q:pred(z:tpl); pre:all x:tpl{or(p,q(x))} con:or(p,all x:tpl{q(x)})} thm T {true} proof T$1 {1. |- all x:obj {or(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackAllOr |- true};", "(true ⇔ false) ∨ ((x is N) ⇔ true)", 1)>]
    ...
    [<DataRow("PrenexPackExAnd_01", "inf PrenexPackExAnd{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{and(p,q(x))} con:and(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex x:obj {and(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackExAnd |- true};", "∃ x:obj {(true ⇔ false) ∧ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackExAnd_02", "inf PrenexPackExAnd{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{and(p,q(x))} con:and(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex n:Nat {and(all y:obj {is(y,K)}, xor(is(n,M), true))} 2. 1, byinf PrenexPackExAnd |- true};", "∃ n:Nat {(∀ y:obj {y is K}) ∧ ((n is M) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackExAnd_03", "inf PrenexPackExAnd{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{and(p,q(x))} con:and(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex z:obj {and(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackExAnd |- true};", "∃ z:obj {¬(true ⩡ false) ∧ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackExIif: pre: ex x:tpl{iif(p, q(x))}
    [<DataRow("PrenexPackExIif_01", "inf PrenexPackExIif{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{iif(p,q(x))} con:iif(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex x:obj {iif(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackExIif |- true};", "∃ x:obj {(true ⇔ false) ⇔ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackExIif_02", "inf PrenexPackExIif{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{iif(p,q(x))} con:iif(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex n:Nat {iif(all y:obj {is(y,M)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackExIif |- true};", "∃ n:Nat {(∀ y:obj {y is M}) ⇔ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackExIif_03", "inf PrenexPackExIif{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{iif(p,q(x))} con:iif(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex z:obj {iif(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackExIif |- true};", "∃ z:obj {¬(true ⩡ false) ⇔ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackExImpl: pre: ex x:tpl{impl(p, q(x))}
    [<DataRow("PrenexPackExImpl_01", "inf PrenexPackExImpl{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{impl(p,q(x))} con:impl(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex x:obj {impl(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackExImpl |- true};", "∃ x:obj {(true ⇔ false) ⇒ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackExImpl_02", "inf PrenexPackExImpl{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{impl(p,q(x))} con:impl(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex n:Nat {impl(all y:obj {is(y,M)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackExImpl |- true};", "∃ n:Nat {(∀ y:obj {y is M}) ⇒ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackExImpl_03", "inf PrenexPackExImpl{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{impl(p,q(x))} con:impl(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex z:obj {impl(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackExImpl |- true};", "∃ z:obj {¬(true ⩡ false) ⇒ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackExOr: pre: ex x:tpl{or(p, q(x))}
    [<DataRow("PrenexPackExOr_01", "inf PrenexPackExOr{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{or(p,q(x))} con:or(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex x:obj {or(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackExOr |- true};", "∃ x:obj {(true ⇔ false) ∨ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackExOr_02", "inf PrenexPackExOr{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{or(p,q(x))} con:or(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex n:Nat {or(all y:obj {is(y,M)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackExOr |- true};", "∃ n:Nat {(∀ y:obj {y is M}) ∨ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackExOr_03", "inf PrenexPackExOr{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{or(p,q(x))} con:or(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex z:obj {or(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackExOr |- true};", "∃ z:obj {¬(true ⩡ false) ∨ ((z is N) ⇒ false)}", 1)>]

    // PrenexPackExXor: pre: ex x:tpl{xor(p, q(x))}
    [<DataRow("PrenexPackExXor_01", "inf PrenexPackExXor{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{xor(p,q(x))} con:xor(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex x:obj {xor(iif(true,false), iif(is(x,N), true))} 2. 1, byinf PrenexPackExXor |- true};", "∃ x:obj {(true ⇔ false) ⩡ ((x is N) ⇔ true)}", 1)>]
    [<DataRow("PrenexPackExXor_02", "inf PrenexPackExXor{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{xor(p,q(x))} con:xor(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex n:Nat {xor(all y:obj {is(y,M)}, xor(is(n,K), true))} 2. 1, byinf PrenexPackExXor |- true};", "∃ n:Nat {(∀ y:obj {y is M}) ⩡ ((n is K) ⩡ true)}", 1)>]
    [<DataRow("PrenexPackExXor_03", "inf PrenexPackExXor{dec ~p:pred~q:pred(z:tpl); pre:ex x:tpl{xor(p,q(x))} con:xor(p,ex x:tpl{q(x)})} thm T {true} proof T$1 {1. |- ex z:obj {xor(not (xor(true,false)), impl(is(z,N), false))} 2. 1, byinf PrenexPackExXor |- true};", "∃ z:obj {¬(true ⩡ false) ⩡ ((z is N) ⇒ false)}", 1)>]

    // PrenexUnpackAndAll: pre: and(p, all x:tpl{q(x)})
    [<DataRow("PrenexUnpackAndAll_01", "inf PrenexUnpackAndAll{dec ~p:pred~q:pred(z:tpl); pre:and(p,all x:tpl{q(x)}) con:all x:tpl{and(p,q(x))}} thm T {true} proof T$1 {1. |- and(iif(true,false), all n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackAndAll |- true};", "(true ⇔ false) ∧ (∀ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackAndAll_02", "inf PrenexUnpackAndAll{dec ~p:pred~q:pred(z:tpl); pre:and(p,all x:tpl{q(x)}) con:all x:tpl{and(p,q(x))}} thm T {true} proof T$1 {1. |- and(ex y:obj {is(y,M)}, all z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackAndAll |- true};", "(∃ y:obj {y is M}) ∧ (∀ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackAndAll_03", "inf PrenexUnpackAndAll{dec ~p:pred~q:pred(z:tpl); pre:and(p,all x:tpl{q(x)}) con:all x:tpl{and(p,q(x))}} thm T {true} proof T$1 {1. |- and(not (xor(true,false)), all x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackAndAll |- true};", "¬(true ⩡ false) ∧ (∀ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackAndEx: pre: and(p, ex x:tpl{q(x)})
    [<DataRow("PrenexUnpackAndEx_01", "inf PrenexUnpackAndEx{dec ~p:pred~q:pred(z:tpl); pre:and(p,ex x:tpl{q(x)}) con:ex x:tpl{and(p,q(x))}} thm T {true} proof T$1 {1. |- and(iif(true,false), ex n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackAndEx |- true};", "(true ⇔ false) ∧ (∃ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackAndEx_02", "inf PrenexUnpackAndEx{dec ~p:pred~q:pred(z:tpl); pre:and(p,ex x:tpl{q(x)}) con:ex x:tpl{and(p,q(x))}} thm T {true} proof T$1 {1. |- and(all z:obj {is(z,K)}, ex y:obj {xor(is(y,M), true)}) 2. 1, byinf PrenexUnpackAndEx |- true};", "(∀ z:obj {z is K}) ∧ (∃ y:obj {(y is M) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackAndEx_03", "inf PrenexUnpackAndEx{dec ~p:pred~q:pred(z:tpl); pre:and(p,ex x:tpl{q(x)}) con:ex x:tpl{and(p,q(x))}} thm T {true} proof T$1 {1. |- and(not (xor(true,false)), ex x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackAndEx |- true};", "¬(true ⩡ false) ∧ (∃ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackIifAll: pre: iif(p, all x:tpl{q(x)})
    [<DataRow("PrenexUnpackIifAll_01", "inf PrenexUnpackIifAll{dec ~p:pred~q:pred(z:tpl); pre:iif(p,all x:tpl{q(x)}) con:all x:tpl{iif(p,q(x))}} thm T {true} proof T$1 {1. |- iif(iif(true,false), all n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackIifAll |- true};", "(true ⇔ false) ⇔ (∀ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackIifAll_02", "inf PrenexUnpackIifAll{dec ~p:pred~q:pred(z:tpl); pre:iif(p,all x:tpl{q(x)}) con:all x:tpl{iif(p,q(x))}} thm T {true} proof T$1 {1. |- iif(all y:obj {is(y,M)}, all z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackIifAll |- true};", "(∀ y:obj {y is M}) ⇔ (∀ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackIifAll_03", "inf PrenexUnpackIifAll{dec ~p:pred~q:pred(z:tpl); pre:iif(p,all x:tpl{q(x)}) con:all x:tpl{iif(p,q(x))}} thm T {true} proof T$1 {1. |- iif(not (xor(true,false)), all x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackIifAll |- true};", "¬(true ⩡ false) ⇔ (∀ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackIifEx: pre: iif(p, ex x:tpl{q(x)})
    [<DataRow("PrenexUnpackIifEx_01", "inf PrenexUnpackIifEx{dec ~p:pred~q:pred(z:tpl); pre:iif(p,ex x:tpl{q(x)}) con:ex x:tpl{iif(p,q(x))}} thm T {true} proof T$1 {1. |- iif(iif(true,false), ex n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackIifEx |- true};", "(true ⇔ false) ⇔ (∃ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackIifEx_02", "inf PrenexUnpackIifEx{dec ~p:pred~q:pred(z:tpl); pre:iif(p,ex x:tpl{q(x)}) con:ex x:tpl{iif(p,q(x))}} thm T {true} proof T$1 {1. |- iif(all y:obj {is(y,M)}, ex z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackIifEx |- true};", "(∀ y:obj {y is M}) ⇔ (∃ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackIifEx_03", "inf PrenexUnpackIifEx{dec ~p:pred~q:pred(z:tpl); pre:iif(p,ex x:tpl{q(x)}) con:ex x:tpl{iif(p,q(x))}} thm T {true} proof T$1 {1. |- iif(not (xor(true,false)), ex x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackIifEx |- true};", "¬(true ⩡ false) ⇔ (∃ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackImplAll: pre: impl(p, all x:tpl{q(x)})
    [<DataRow("PrenexUnpackImplAll_01", "inf PrenexUnpackImplAll{dec ~p:pred~q:pred(z:tpl); pre:impl(p,all x:tpl{q(x)}) con:all x:tpl{impl(p,q(x))}} thm T {true} proof T$1 {1. |- impl(iif(true,false), all n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackImplAll |- true};", "(true ⇔ false) ⇒ (∀ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackImplAll_02", "inf PrenexUnpackImplAll{dec ~p:pred~q:pred(z:tpl); pre:impl(p,all x:tpl{q(x)}) con:all x:tpl{impl(p,q(x))}} thm T {true} proof T$1 {1. |- impl(all y:obj {is(y,M)}, all z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackImplAll |- true};", "(∀ y:obj {y is M}) ⇒ (∀ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackImplAll_03", "inf PrenexUnpackImplAll{dec ~p:pred~q:pred(z:tpl); pre:impl(p,all x:tpl{q(x)}) con:all x:tpl{impl(p,q(x))}} thm T {true} proof T$1 {1. |- impl(not (xor(true,false)), all x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackImplAll |- true};", "¬(true ⩡ false) ⇒ (∀ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackImplEx: pre: impl(p, ex x:tpl{q(x)})
    [<DataRow("PrenexUnpackImplEx_01", "inf PrenexUnpackImplEx{dec ~p:pred~q:pred(z:tpl); pre:impl(p,ex x:tpl{q(x)}) con:ex x:tpl{impl(p,q(x))}} thm T {true} proof T$1 {1. |- impl(iif(true,false), ex n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackImplEx |- true};", "(true ⇔ false) ⇒ (∃ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackImplEx_02", "inf PrenexUnpackImplEx{dec ~p:pred~q:pred(z:tpl); pre:impl(p,ex x:tpl{q(x)}) con:ex x:tpl{impl(p,q(x))}} thm T {true} proof T$1 {1. |- impl(all y:obj {is(y,M)}, ex z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackImplEx |- true};", "(∀ y:obj {y is M}) ⇒ (∃ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackImplEx_03", "inf PrenexUnpackImplEx{dec ~p:pred~q:pred(z:tpl); pre:impl(p,ex x:tpl{q(x)}) con:ex x:tpl{impl(p,q(x))}} thm T {true} proof T$1 {1. |- impl(not (xor(true,false)), ex x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackImplEx |- true};", "¬(true ⩡ false) ⇒ (∃ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackOrAll: pre: or(p, all x:tpl{q(x)})
    [<DataRow("PrenexUnpackOrAll_01", "inf PrenexUnpackOrAll{dec ~p:pred~q:pred(z:tpl); pre:or(p,all x:tpl{q(x)}) con:all x:tpl{or(p,q(x))}} thm T {true} proof T$1 {1. |- or(iif(true,false), all n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackOrAll |- true};", "(true ⇔ false) ∨ (∀ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackOrAll_02", "inf PrenexUnpackOrAll{dec ~p:pred~q:pred(z:tpl); pre:or(p,all x:tpl{q(x)}) con:all x:tpl{or(p,q(x))}} thm T {true} proof T$1 {1. |- or(ex y:obj {is(y,M)}, all z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackOrAll |- true};", "(∃ y:obj {y is M}) ∨ (∀ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackOrAll_03", "inf PrenexUnpackOrAll{dec ~p:pred~q:pred(z:tpl); pre:or(p,all x:tpl{q(x)}) con:all x:tpl{or(p,q(x))}} thm T {true} proof T$1 {1. |- or(not (xor(true,false)), all x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackOrAll |- true};", "¬(true ⩡ false) ∨ (∀ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackOrEx: pre: or(p, ex x:tpl{q(x)})
    [<DataRow("PrenexUnpackOrEx_01", "inf PrenexUnpackOrEx{dec ~p:pred~q:pred(z:tpl); pre:or(p,ex x:tpl{q(x)}) con:ex x:tpl{or(p,q(x))}} thm T {true} proof T$1 {1. |- or(iif(true,false), ex n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackOrEx |- true};", "(true ⇔ false) ∨ (∃ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackOrEx_02", "inf PrenexUnpackOrEx{dec ~p:pred~q:pred(z:tpl); pre:or(p,ex x:tpl{q(x)}) con:ex x:tpl{or(p,q(x))}} thm T {true} proof T$1 {1. |- or(all y:obj {is(y,M)}, ex z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackOrEx |- true};", "(∀ y:obj {y is M}) ∨ (∃ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackOrEx_03", "inf PrenexUnpackOrEx{dec ~p:pred~q:pred(z:tpl); pre:or(p,ex x:tpl{q(x)}) con:ex x:tpl{or(p,q(x))}} thm T {true} proof T$1 {1. |- or(not (xor(true,false)), ex x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackOrEx |- true};", "¬(true ⩡ false) ∨ (∃ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackXorAll: pre: xor(p, all x:tpl{q(x)})
    [<DataRow("PrenexUnpackXorAll_01", "inf PrenexUnpackXorAll{dec ~p:pred~q:pred(z:tpl); pre:xor(p,all x:tpl{q(x)}) con:all x:tpl{xor(p,q(x))}} thm T {true} proof T$1 {1. |- xor(iif(true,false), all n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackXorAll |- true};", "(true ⇔ false) ⩡ (∀ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackXorAll_02", "inf PrenexUnpackXorAll{dec ~p:pred~q:pred(z:tpl); pre:xor(p,all x:tpl{q(x)}) con:all x:tpl{xor(p,q(x))}} thm T {true} proof T$1 {1. |- xor(all y:obj {is(y,M)}, all z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackXorAll |- true};", "(∀ y:obj {y is M}) ⩡ (∀ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackXorAll_03", "inf PrenexUnpackXorAll{dec ~p:pred~q:pred(z:tpl); pre:xor(p,all x:tpl{q(x)}) con:all x:tpl{xor(p,q(x))}} thm T {true} proof T$1 {1. |- xor(not (xor(true,false)), all x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackXorAll |- true};", "¬(true ⩡ false) ⩡ (∀ x:obj {(x is N) ⇒ false})", 1)>]

    // PrenexUnpackXorEx: pre: xor(p, ex x:tpl{q(x)})
    [<DataRow("PrenexUnpackXorEx_01", "inf PrenexUnpackXorEx{dec ~p:pred~q:pred(z:tpl); pre:xor(p,ex x:tpl{q(x)}) con:ex x:tpl{xor(p,q(x))}} thm T {true} proof T$1 {1. |- xor(iif(true,false), ex n:Nat {iif(is(n,N), true)}) 2. 1, byinf PrenexUnpackXorEx |- true};", "(true ⇔ false) ⩡ (∃ n:Nat {(n is N) ⇔ true})", 1)>]
    [<DataRow("PrenexUnpackXorEx_02", "inf PrenexUnpackXorEx{dec ~p:pred~q:pred(z:tpl); pre:xor(p,ex x:tpl{q(x)}) con:ex x:tpl{xor(p,q(x))}} thm T {true} proof T$1 {1. |- xor(all y:obj {is(y,M)}, ex z:obj {xor(is(z,K), true)}) 2. 1, byinf PrenexUnpackXorEx |- true};", "(∀ y:obj {y is M}) ⩡ (∃ z:obj {(z is K) ⩡ true})", 1)>]
    [<DataRow("PrenexUnpackXorEx_03", "inf PrenexUnpackXorEx{dec ~p:pred~q:pred(z:tpl); pre:xor(p,ex x:tpl{q(x)}) con:ex x:tpl{xor(p,q(x))}} thm T {true} proof T$1 {1. |- xor(not (xor(true,false)), ex x:obj {impl(is(x,N), false)}) 2. 1, byinf PrenexUnpackXorEx |- true};", "¬(true ⩡ false) ⩡ (∃ x:obj {(x is N) ⇒ false})", 1)>]
    ...
    [<DataRow("Proceeding3Results_03", "inf Proceeding3Results{dec ~p,q,s:pred; pre:p,q,s con:and(and(p,q),s)} thm T {true} proof T$1 {1. |- not (xor(true, false)) 2. |- impl(true, false) 3. |- exn$1 u:obj {is(u, L)} 4. 1, 2, 3, byinf Proceeding3Results |- true};", "(¬(true ⩡ false) ∧ (true ⇒ false)) ∧ (exn$1 u:obj {u is L})", 1)>]
    ...
    // WeakeningRule: pre: p
    [<DataRow("WeakeningRule_01", "inf WeakeningRule{dec ~p,q:pred; pre:p con:impl(q,p)} thm T {true} proof T$1 {1. |- iif(true, ex x:obj {is(x,N)}) 2. 1, byinf WeakeningRule |- true};", "true ⇔ (∃ x:obj {x is N})", 1)>]
    [<DataRow("WeakeningRule_02", "inf WeakeningRule{dec ~p,q:pred; pre:p con:impl(q,p)} thm T {true} proof T$1 {1. |- all x:obj {is(x,N)} 2. 1, byinf WeakeningRule |- true};", "∀ x:obj {x is N}", 1)>]
    [<DataRow("WeakeningRule_03", "inf WeakeningRule{dec ~p,q:pred; pre:p con:impl(q,p)} thm T {true} proof T$1 {1. |- and(not (xor(true,false)), iif(true,false)) 2. 1, byinf WeakeningRule |- true};", "¬(true ⩡ false) ∧ (true ⇔ false)", 1)>]
    ...
    [<DataRow("XorA_02", "inf XorAssociative{dec ~p,q,s:pred; pre:xor(p,xor(q,s)) con:xor(xor(p,q),s)} thm T {true} proof T$1 {1. |- xor(xor(true,false), true) 2. 1, byinf XorAssociative |- xor(xor(true,false), true)};", "(true ⩡ false) ⩡ true", 1)>]
    ...
    [<DataRow("XorC_02", "inf XorCummutative{dec ~p,q:pred; pre:xor(p,q) con:xor(q,p)} thm T {true} proof T$1 {1. |- xor(true,true) 2. 1, byinf XorCummutative |- xor(true,true)};", "true ⩡ true", 1)>]
