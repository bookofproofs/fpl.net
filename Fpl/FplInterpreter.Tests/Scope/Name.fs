...
type Name() =
    ...
    member this.TestScopeBlocksName(var) =
        let res = TestCases.ScopeBlocks("Name") 
        match res with
    ...
    member this.TestConstructors(var) =
        let res = TestCases.ScopeConstructors("Name") 
        match res with
    ...
    member this.TestProofsAndCorollaries(var) =
        let res = TestCases.ScopeProofsAndCorollaries("Name") 
        match res with
    ...
    member this.TestProperties(var) =
        let res = TestCases.ScopeProperties("Name") 
        match res with
    ...
    member this.TestVariablesInBlock(var) =
        let result = TestCases.ScopeVariablesInBlock("Name")
        match result with
    ...
    member this.TestVariablesInBlockVariadic(var) =
        let result = TestCases.ScopeVariablesInBlockVariadic("Name")
        match result with
    ...
    member this.TestVariablesInSignature(var) =
        let result = TestCases.ScopeVariablesInSignature("Name")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Mixed))
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        let result = TestCases.ScopeVariablesInSignatureVariadic("Name")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Mixed))
    ...
    member this.TestPredicateName(var, varVal) =
        ...
        | "base11a" -> Assert.AreEqual<string>("v.x", base1.Type(SignatureType.Name))
    ...
    member this.TestBaseConstructorCall(var, varVal) =
        ...
        | "base3" -> Assert.AreEqual<string>("D(A, T1, func)", base1.Type(SignatureType.Mixed))
        | "base4" -> Assert.AreEqual<string>("B(In)", base1.Type(SignatureType.Mixed))
        | "base5" -> Assert.AreEqual<string>("C(Test1, Test2)", base1.Type(SignatureType.Mixed))
