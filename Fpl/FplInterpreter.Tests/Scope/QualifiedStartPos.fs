...
type QualifiedStartPos() =
    ...
    member this.TestBlocks(var) =
        let res = TestCases.ScopeBlocks("QualifiedStartPos") 
        match res with
    ...
    member this.TestConstructors(var) =
        let res = TestCases.ScopeConstructors("QualifiedStartPos") 
        match res with
    ...
    member this.TestProofsAndCorollaries(var) =
        let res = TestCases.ScopeProofsAndCorollaries("QualifiedStartPos") 
        match res with
    ...
    member this.TestProperties(var) =
        let res = TestCases.ScopeProperties("QualifiedStartPos") 
        match res with
        | Some (r:FplRoot,theory:FplGenericNode,block:FplGenericNode,t1:FplGenericNode,t3:FplGenericNode,t5:FplGenericNode,t7:FplGenericNode,t9:FplGenericNode,t11:FplGenericNode,t13:FplGenericNode) -> 
            ...
            | "r" -> Assert.AreEqual<string>("", r.QualifiedStartPos)
            | PrimTheoryL -> Assert.IsTrue((theory.QualifiedStartPos).Contains("Ln: 1, Col: 1)"))
            | "block" -> Assert.IsTrue((block.QualifiedStartPos).Contains("Ln: 3, Col: 13)"))
            | "t1" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 6, Col: 13)", t1.QualifiedStartPos)
            | "t3" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 7, Col: 13)", t3.QualifiedStartPos)
            | "t5" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 8, Col: 13)", t5.QualifiedStartPos)
            | "t7" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 9, Col: 13)", t7.QualifiedStartPos)
            | "t9" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 10, Col: 13)", t9.QualifiedStartPos)
            | "t11" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 11, Col: 13)", t11.QualifiedStartPos)
            | "t13" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 12, Col: 13)", t13.QualifiedStartPos)
            | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestVariablesInBlock(var) =
        let result = TestCases.ScopeVariablesInBlock("QualifiedStartPos")
        match result with
    ...
    member this.TestVariablesInBlockVariadic(var) =
        let result = TestCases.ScopeVariablesInBlockVariadic("QualifiedStartPos")
        match result with
    ...
    member this.TestVariablesInSignature(var) =
        let result = TestCases.ScopeVariablesInSignature("QualifiedStartPos")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with
            | "r" -> Assert.AreEqual<string>("", r.QualifiedStartPos)
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        let result = TestCases.ScopeVariablesInSignatureVariadic("QualifiedStartPos")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with
            | "r" -> Assert.AreEqual<string>("", r.QualifiedStartPos)
