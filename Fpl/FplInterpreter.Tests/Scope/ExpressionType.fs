...
type TestFplValueScopeExpressionType() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | "base15" -> Assert.AreEqual<FixType>(FixType.Prefix "-", base1.ExpressionType)
        | "base15a" -> Assert.AreEqual<FixType>(FixType.Postfix "'", base1.ExpressionType)
        | "base15b" -> Assert.AreEqual<FixType>(FixType.Prefix "-", base1.ExpressionType)
        | "base16" -> Assert.AreEqual<FixType>(FixType.Prefix "-", base1.ExpressionType)
        | "base17" -> Assert.AreEqual<FixType>(FixType.Postfix "'", base1.ExpressionType)
