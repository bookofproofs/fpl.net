...
type Parent() =
    ...
    member this.TestBlocks(var) =
        let res = TestCases.ScopeBlocks("Parent") 
        match res with
        | Some (r:FplRoot,theory:FplGenericNode,inf1:FplGenericNode,inf2:FplGenericNode,axi1:FplGenericNode,axi2:FplGenericNode,pst1:FplGenericNode,pst2:FplGenericNode,thm1:FplGenericNode,thm2:FplGenericNode,pro1:FplGenericNode,pro2:FplGenericNode,lem1:FplGenericNode,lem2:FplGenericNode,cor1:FplGenericNode,cor2:FplGenericNode,con1:FplGenericNode,con2:FplGenericNode,cla1:FplGenericNode,cla2:FplGenericNode,pre1:FplGenericNode,pre2:FplGenericNode,fun1:FplGenericNode,fun2:FplGenericNode,fun3:FplGenericNode,fun4:FplGenericNode,fun5:FplGenericNode,fun6:FplGenericNode,fun7:FplGenericNode,fun8:FplGenericNode,fun9:FplGenericNode,prf1:FplGenericNode,prf2:FplGenericNode,loc1:FplGenericNode,loc2:FplGenericNode) -> 
            match var with 
            | "r" -> Assert.AreEqual<FplGenericNode option>(None, r.Parent)
            | PrimTheoryL -> Assert.AreEqual<FplGenericNode>(r, theory.Parent.Value)
            | "inf1" -> Assert.AreEqual<FplGenericNode>(theory, inf1.Parent.Value)
            | "inf2" -> Assert.AreEqual<FplGenericNode>(theory, inf2.Parent.Value)
            | "axi1" -> Assert.AreEqual<FplGenericNode>(theory, axi1.Parent.Value)
            | "axi2" -> Assert.AreEqual<FplGenericNode>(theory, axi2.Parent.Value)
            | "pst1" -> Assert.AreEqual<FplGenericNode>(theory, pst1.Parent.Value)
            | "pst2" -> Assert.AreEqual<FplGenericNode>(theory, pst2.Parent.Value)
            | "thm1" -> Assert.AreEqual<FplGenericNode>(theory, thm1.Parent.Value)
            | "thm2" -> Assert.AreEqual<FplGenericNode>(theory, thm2.Parent.Value)
            | "pro1" -> Assert.AreEqual<FplGenericNode>(theory, pro1.Parent.Value)
            | "pro2" -> Assert.AreEqual<FplGenericNode>(theory, pro2.Parent.Value)
            | "lem1" -> Assert.AreEqual<FplGenericNode>(theory, lem1.Parent.Value)
            | "lem2" -> Assert.AreEqual<FplGenericNode>(theory, lem2.Parent.Value)
            | "cor1" -> Assert.AreEqual<FplGenericNode>(lem1, cor1.Parent.Value)
            | "cor2" -> Assert.AreEqual<FplGenericNode>(lem2, cor2.Parent.Value)
            | "con1" -> Assert.AreEqual<FplGenericNode>(theory, con1.Parent.Value)
            | "con2" -> Assert.AreEqual<FplGenericNode>(theory, con2.Parent.Value)
            | "cla1" -> Assert.AreEqual<FplGenericNode>(theory, cla1.Parent.Value)
            | "cla2" -> Assert.AreEqual<FplGenericNode>(theory, cla2.Parent.Value)
            | "pre1" -> Assert.AreEqual<FplGenericNode>(theory, pre1.Parent.Value)
            | "pre2" -> Assert.AreEqual<FplGenericNode>(theory, pre2.Parent.Value)
            | "fun1" -> Assert.AreEqual<FplGenericNode>(theory, fun1.Parent.Value)
            | "fun2" -> Assert.AreEqual<FplGenericNode>(theory, fun2.Parent.Value)
            | "fun3" -> Assert.AreEqual<FplGenericNode>(theory, fun3.Parent.Value)
            | "fun4" -> Assert.AreEqual<FplGenericNode>(theory, fun4.Parent.Value)
            | "fun5" -> Assert.AreEqual<FplGenericNode>(theory, fun5.Parent.Value)
            | "fun6" -> Assert.AreEqual<FplGenericNode>(theory, fun6.Parent.Value)
            | "fun7" -> Assert.AreEqual<FplGenericNode>(theory, fun7.Parent.Value)
            | "fun8" -> Assert.AreEqual<FplGenericNode>(theory, fun8.Parent.Value)
            | "fun9" -> Assert.AreEqual<FplGenericNode>(theory, fun9.Parent.Value)
            | "prf1" -> Assert.AreEqual<FplGenericNode>(thm1, prf1.Parent.Value)
            | "prf2" -> Assert.AreEqual<FplGenericNode>(thm2, prf2.Parent.Value)
            | "loc1" -> Assert.AreEqual<FplGenericNode>(theory, loc1.Parent.Value)
            | "loc2" -> Assert.AreEqual<FplGenericNode>(theory, loc2.Parent.Value)
    ...
    member this.TestConstructors(var) =
        let res = TestCases.ScopeConstructors("Parent") 
        match res with
        | Some (r,theory,block:FplGenericNode,t1:FplGenericNode,t2:FplGenericNode,t3:FplGenericNode,t4:FplGenericNode) -> 
            match var with 
            | "r" -> Assert.AreEqual<FplGenericNode option>(None, r.Parent)
            | PrimTheoryL -> Assert.AreEqual<FplGenericNode>(r, theory.Parent.Value)
            | "block" -> Assert.AreEqual<FplGenericNode>(theory, block.Parent.Value)
            | "t1" -> Assert.AreEqual<FplGenericNode>(block, t1.Parent.Value)
            | "t2" -> Assert.AreEqual<FplGenericNode>(block, t2.Parent.Value)
            | "t3" -> Assert.AreEqual<FplGenericNode>(block, t3.Parent.Value)
            | "t4" -> Assert.AreEqual<FplGenericNode>(block, t4.Parent.Value)
            | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestProofsAndCorollaries(var) =
        let res = TestCases.ScopeProofsAndCorollaries("Parent")  
        match res with
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | PrimTheoryL -> Assert.AreEqual<FplGenericNode>(r, theory.Parent.Value)
                | "thm1" -> Assert.AreEqual<FplGenericNode>(theory, thm1.Parent.Value)
                | "proofThm1" -> Assert.AreEqual<FplGenericNode>(thm1, proofThm1.Parent.Value)
                | "lem1" -> Assert.AreEqual<FplGenericNode>(theory, lem1.Parent.Value)
                | "proofLem1" -> Assert.AreEqual<FplGenericNode>(lem1, proofLem1.Parent.Value)
                | "prp1" -> Assert.AreEqual<FplGenericNode>(theory, prp1.Parent.Value)
                | "proofPrp1" -> Assert.AreEqual<FplGenericNode>(prp1, proofPrp1.Parent.Value)
                | "cor1" -> Assert.AreEqual<FplGenericNode>(theory, cor1.Parent.Value)
                | "proofCor1" -> Assert.AreEqual<FplGenericNode>(cor1, proofCor1.Parent.Value)
                | "thm2" -> Assert.AreEqual<FplGenericNode>(theory, thm2.Parent.Value)
                | "corThm2" -> Assert.AreEqual<FplGenericNode>(thm2, corThm2.Parent.Value)
                | "lem2" -> Assert.AreEqual<FplGenericNode>(theory, lem2.Parent.Value)
                | "corLem2" -> Assert.AreEqual<FplGenericNode>(lem2, corLem2.Parent.Value)
                | "prp2" -> Assert.AreEqual<FplGenericNode>(theory, prp2.Parent.Value)
                | "corPrp2" -> Assert.AreEqual<FplGenericNode>(prp2, corPrp2.Parent.Value)
                | "cor2" -> Assert.AreEqual<FplGenericNode>(theory, cor2.Parent.Value)
                | "corCor2" -> Assert.AreEqual<FplGenericNode>(cor2, corCor2.Parent.Value)
                | "con1" -> Assert.AreEqual<FplGenericNode>(theory, con1.Parent.Value)
                | "corCon1" -> Assert.AreEqual<FplGenericNode>(con1, corCon1.Parent.Value)
                | "axi1" -> Assert.AreEqual<FplGenericNode>(theory, axi1.Parent.Value)
                | "corAxi1"  -> Assert.AreEqual<FplGenericNode>(axi1, corAxi1.Parent.Value) 
                | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestProperties(var) =
        let res = TestCases.ScopeProperties("Parent") 
        match res with
        | Some (r:FplRoot,theory:FplGenericNode,block:FplGenericNode,t1:FplGenericNode,t3:FplGenericNode,t5:FplGenericNode,t7:FplGenericNode,t9:FplGenericNode,t11:FplGenericNode,t13:FplGenericNode) -> 
            ...
            | "t1" -> Assert.AreEqual<FplGenericNode>(block, t1.Parent.Value)
            | "t3" -> Assert.AreEqual<FplGenericNode>(block, t3.Parent.Value)
            | "t5" -> Assert.AreEqual<FplGenericNode>(block, t5.Parent.Value)
            | "t7" -> Assert.AreEqual<FplGenericNode>(block, t7.Parent.Value)
            | "t9" -> Assert.AreEqual<FplGenericNode>(block, t9.Parent.Value)
            | "t11" -> Assert.AreEqual<FplGenericNode>(block, t11.Parent.Value)
            | "t13" -> Assert.AreEqual<FplGenericNode>(block, t13.Parent.Value)
            | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestVariablesInBlock(var) =
        let result = TestCases.ScopeVariablesInBlock("Parent")
        match result with
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with 
            | "ywc" -> Assert.AreEqual<FplGenericNode>(yw, ywc.Parent.Value)
            | "ywb" -> Assert.AreEqual<FplGenericNode>(yw, ywb.Parent.Value)
            | "ywa" -> Assert.AreEqual<FplGenericNode>(yw, ywa.Parent.Value)
            | "yvc" -> Assert.AreEqual<FplGenericNode>(yv, yvc.Parent.Value)
            | "yvb" -> Assert.AreEqual<FplGenericNode>(yv, yvb.Parent.Value)
            | "yva" -> Assert.AreEqual<FplGenericNode>(yv, yva.Parent.Value)
            | "yuc" -> Assert.AreEqual<FplGenericNode>(yu, yuc.Parent.Value)
            | "yub" -> Assert.AreEqual<FplGenericNode>(yu, yub.Parent.Value)
            | "yua" -> Assert.AreEqual<FplGenericNode>(yu, yua.Parent.Value)
            | "xwc" -> Assert.AreEqual<FplGenericNode>(xw, xwc.Parent.Value)
            | "xwb" -> Assert.AreEqual<FplGenericNode>(xw, xwb.Parent.Value)
            | "xwa" -> Assert.AreEqual<FplGenericNode>(xw, xwa.Parent.Value)
            | "xvc" -> Assert.AreEqual<FplGenericNode>(xv, xvc.Parent.Value)
            | "xvb" -> Assert.AreEqual<FplGenericNode>(xv, xvb.Parent.Value)
            | "xva" -> Assert.AreEqual<FplGenericNode>(xv, xva.Parent.Value)
            | "xuc" -> Assert.AreEqual<FplGenericNode>(xu, xuc.Parent.Value)
            | "xub" -> Assert.AreEqual<FplGenericNode>(xu, xub.Parent.Value)
            | "xua" -> Assert.AreEqual<FplGenericNode>(xu, xua.Parent.Value)

            | "yw" -> Assert.AreEqual<FplGenericNode>(y, yw.Parent.Value)
            | "yv" -> Assert.AreEqual<FplGenericNode>(y, yv.Parent.Value)
            | "yu" -> Assert.AreEqual<FplGenericNode>(y, yu.Parent.Value)
            | "xw" -> Assert.AreEqual<FplGenericNode>(x, xw.Parent.Value)
            | "xv" -> Assert.AreEqual<FplGenericNode>(x, xv.Parent.Value)
            | "xu" -> Assert.AreEqual<FplGenericNode>(x,  xu.Parent.Value)
            | "y" -> Assert.AreEqual<FplGenericNode>(block, y.Parent.Value)
            | "x" -> Assert.AreEqual<FplGenericNode>(block, x.Parent.Value)
            | "s" -> Assert.AreEqual<FplGenericNode>(block, s.Parent.Value)
            | "block" -> Assert.AreEqual<FplGenericNode>(theory, block.Parent.Value)
            | PrimTheoryL -> Assert.AreEqual<FplGenericNode>(r, theory.Parent.Value)
            | "r" -> Assert.AreEqual<FplGenericNode option>(None, r.Parent)
            | _ -> 
    ...
    member this.TestVariablesInBlockVariadic(var) =
        let result = TestCases.ScopeVariablesInBlockVariadic("Parent")
        match result with
    ...
    member this.TestVariablesInSignature(var) =
        let result = TestCases.ScopeVariablesInSignature("Parent")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with 
            | "ywc" -> Assert.AreEqual<FplGenericNode>(yw, ywc.Parent.Value)
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        let result = TestCases.ScopeVariablesInSignatureVariadic("Parent")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with 
            | "ywc" -> Assert.AreEqual<FplGenericNode>(yw, ywc.Parent.Value)
