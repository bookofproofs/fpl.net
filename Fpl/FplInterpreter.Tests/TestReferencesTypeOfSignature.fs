...
type TestReferencesTypeOfSignature() =
    ...
    member this.TestPredicateReference(var, fplCode) =
        ...
        | Some st -> 
            ...
            | "base11v1" -> Assert.AreEqual<string>("obj", base1.Type(true))
            | "base11v2" -> Assert.AreEqual<string>("ind", base1.Type(true))
            | "base11v3" -> Assert.AreEqual<string>("Nat", base1.Type(true))
            ...
            | "base10c" -> Assert.AreEqual<string>("Test(NatNat)", base1.Type(true))
            | "base11c" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Type(true))
            | "base12c" -> Assert.AreEqual<string>("self(undef, undef)", base1.Type(true))
            | "base13c" -> Assert.AreEqual<string>("1(undef, undef)", base1.Type(true))
            | "base10d" -> Assert.AreEqual<string>("Test[undef, undef]", base1.Type(true))
            | "base11d" -> Assert.AreEqual<string>("undef[undef, undef]", base1.Type(true))
            | "base12d" -> Assert.AreEqual<string>("self[undef, undef]", base1.Type(true))
            | "base13d" -> Assert.AreEqual<string>("1[undef.undef]", base1.Type(true))
            | "base10e" -> Assert.AreEqual<string>("Test(undef, undef).@self[undef, undef]", base1.Type(true))
            | "base11e" -> Assert.AreEqual<string>("undef(undef, undef).undef[undef, undef]", base1.Type(true))
            | "base12e" -> Assert.AreEqual<string>("self(undef, undef).3[undef, undef]", base1.Type(true))
            | "base13e" -> Assert.AreEqual<string>("1(undef, undef).T[undef, undef]", base1.Type(true))
            | "base10f" -> Assert.AreEqual<string>("Test[undef, undef].undef(undef, undef)", base1.Type(true))
            | "base11f" -> Assert.AreEqual<string>("undef[undef, undef].undef(undef, undef)", base1.Type(true))
            | "base12f" -> Assert.AreEqual<string>("self[undef, undef].self(undef, undef)", base1.Type(true))
            | "base13f" -> Assert.AreEqual<string>("1[undef.undef].T(undef, undef)", base1.Type(true))
            ...
            | "base18" -> Assert.AreEqual<string>("", base1.Type(true))
            | "base19" -> Assert.AreEqual<string>("", base1.Type(true))
            | "base20" -> Assert.AreEqual<string>("", base1.Type(true))
            | "base21" -> Assert.AreEqual<string>("and(undef, undef, undef)", base1.Type(true))
            | "base21a" -> Assert.AreEqual<string>("not(undef)", base1.Type(true))
            | "base21b" -> Assert.AreEqual<string>("not(undef)", base1.Type(true))
            | "base22" -> Assert.AreEqual<string>("xor(undef, undef, undef)", base1.Type(true))
            | "base23" -> Assert.AreEqual<string>("or(undef, undef, undef)", base1.Type(true))
            | "base24" -> Assert.AreEqual<string>("iif(undef, undef)", base1.Type(true))
            | "base25" -> Assert.AreEqual<string>("impl(undef, undef)", base1.Type(true))
            | "base26" -> Assert.AreEqual<string>("is(undef, Nat)", base1.Type(true))
            | "base27" -> Assert.AreEqual<string>("B()", base1.Type(true))
            | "base28" -> Assert.AreEqual<string>("C(undef, undef, undef, undef)", base1.Type(true))
            | "base29" -> Assert.AreEqual<string>("D(selfundef, undef)", base1.Type(true))
            | "base30" -> Assert.AreEqual<string>("B(In(undef))", base1.Type(true))
            | "base31" -> Assert.AreEqual<string>("C(Test1(undef), Test2(undef, undef, undef))", base1.Type(true))
            | "base32" -> Assert.AreEqual<string>("E(pred, undef, undef)", base1.Type(true))
    ...
    member this.TestCallConstructorParentClass(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base6" -> Assert.AreEqual<string>("E(pred, undef, undef)", base1.Type(true))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base2" -> Assert.AreEqual<string>("del.C(undef, undef, undef, undef)", base1.Type(true))
            | "base3" -> Assert.AreEqual<string>("del.D(selfundef, undef)", base1.Type(true))
            | "base4" -> Assert.AreEqual<string>("del.B(In(undef))", base1.Type(true))
            | "base5" -> Assert.AreEqual<string>("del.Test()", base1.Type(true))
            | "base6" -> Assert.AreEqual<string>("del.C(Test1(undef), Test2(undef, undef, undef))", base1.Type(true))
            | "base7" -> Assert.AreEqual<string>("del.E(pred, undef, undef)", base1.Type(true))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
