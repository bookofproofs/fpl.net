...
type TestReferencesTypeOfSignature() =
    ...
    member this.TestPredicateReference(var, fplCode) =
        ...
        | Some st -> 
            ...
            | "base10c" -> Assert.AreEqual<string>("Test(NatNat)", base1.Type(SignatureType.Type))
            ...
            | "base21" -> Assert.AreEqual<string>("and(undef, undef, undef)", base1.Type(SignatureType.Type))
            ...
            | "base22" -> Assert.AreEqual<string>("xor(undef, undef, undef)", base1.Type(SignatureType.Type))
            | "base23" -> Assert.AreEqual<string>("or(undef, undef, undef)", base1.Type(SignatureType.Type))
            ...
            | "base26" -> Assert.AreEqual<string>("is(undef, Nat)", base1.Type(SignatureType.Type))
            ...
            | "base32" -> Assert.AreEqual<string>("E(pred, undef, undef)", base1.Type(SignatureType.Type))
