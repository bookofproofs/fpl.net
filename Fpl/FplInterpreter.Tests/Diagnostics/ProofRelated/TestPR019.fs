...
(* PR019
   ...
   What it indicates: A proof argument collected preceding justification items that use incompatible justification kinds (for example `byax` mixed with `byconj`, `byax` mixed with a direct theorem reference, etc.). Such mixtures are not allowed and prevent deterministic argument inference.
