...
(* PR015
   ...
   What it indicates: A `revoke` step referenced an argument identifier that was not previously assumed in the current proof (or was already revoked). 
...
type TestPR015() =
    ...
    [<DataRow("04", "proof T$1 {1: assume x 2: revoke 1 3: revoke 1}", 1)>]
