...
type TestPR020() =
    ...
    [<DataRow("02", """inf Proceeding2Results{dec p,q:pred; pre:p,q con:and(p,q)} thm T {true} proof T$1 {1: and(true,false) 2: impl(true,false) 3. 1, 2, byinf Proceeding2Results |- true}""", 0)>]
    [<DataRow("02a", """inf Proceeding2Results{dec p,q:pred; pre:p,q con:and(p,q)} thm T {true} proof T$1 {1: and(true,false) 2. 1, byinf Proceeding2Results |- true}""", 1)>]
    [<DataRow("02b", """inf Proceeding2Results{dec p,q:pred; pre:p,q con:and(p,q)} thm T {true} proof T$1 {1: and(true,false) 2: impl(true,false) 3: true 4. 1, 2, 3, byinf Proceeding2Results |- true}""", 1)>]
    ...
    [<DataRow("02a", """inf Proceeding2Results{dec p,q:pred; pre:p,q con:and(p,q)} thm T {true} proof T$1 {1: and(true,false) 2. 1, byinf Proceeding2Results |- true}""", 2, 1)>]
    [<DataRow("02b", """inf Proceeding2Results{dec p,q:pred; pre:p,q con:and(p,q)} thm T {true} proof T$1 {1: and(true,false) 2: impl(true,false) 3. 1, 2, 3, byinf Proceeding2Results |- true}""", 2, 3)>]
    [<TestMethod>]
