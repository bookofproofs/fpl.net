...
type TestFplValue() =
    ...
    [<DataRow("def class Test proof Test$1 {1. |- trivial};", "Test", "Test")>]
    [<DataRow("def class TestId;", "TestId", "TestId")>]
    ...
    [<DataRow("def cl T {ctor T(x:ind) {}};", "T(ind)", "T(ind)")>]
    [<DataRow("def cl T {ctor T(x:pred) {}};", "T(pred)", "T(pred)")>]
    [<DataRow("def cl T {ctor T(x:func) {}};", "T(func)", "T(func)")>]
    [<DataRow("def cl T {ctor T(x:obj) {}};", "T(obj)", "T(obj)")>]
    [<DataRow("def cl T {ctor T(x:index) {}};", "T(ind)", "T(ind)")>]
    [<DataRow("def cl T {ctor T(x:predicate) {}};", "T(pred)", "T(pred)")>]
    [<DataRow("def cl T {ctor T(x:function) {}};", "T(func)", "T(func)")>]
    [<DataRow("def cl T {ctor T(x:object) {}};", "T(obj)", "T(obj)")>]
    [<DataRow("def cl T {ctor T(x:Nat) {}};", "T(Nat)", "T(Nat)")>]
    [<DataRow("def cl T {ctor T(x:@Nat) {}};", "T(@Nat)", "T(@Nat)")>]
    [<DataRow("def cl T {ctor T(x:tpl) {}};", "T(tpl)", "T(tpl)")>]
    [<DataRow("def cl T {ctor T(x:template) {}};", "T(template)", "T(template)")>]
    [<DataRow("def cl T {ctor T(x:tplTest) {}};", "T(tplTest)", "T(tplTest)")>]
    [<DataRow("def cl T {ctor T(x:templateTest) {}};", "T(templateTest)", "T(templateTest)")>]
    [<DataRow("def cl T {ctor T(x,y,z:obj) {}};", "T(obj, obj, obj)", "T(obj, obj, obj)")>]
    [<DataRow("def cl T {ctor T(x,y:pred(z:obj)) {}};", "T(pred(obj), pred(obj))", "T(pred(obj), pred(obj))")>]
    [<DataRow("def cl T {ctor T(x,y:pred(u,v,w:obj)) {}};", "T(pred(obj, obj, obj), pred(obj, obj, obj))", "T(pred(obj, obj, obj), pred(obj, obj, obj))")>]
    [<DataRow("def cl T {ctor T(x:func(u:obj)->Nat) {}};", "T(func(obj) -> Nat)", "T(func(obj) -> Nat)")>]
