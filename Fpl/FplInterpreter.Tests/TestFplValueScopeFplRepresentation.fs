...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue,loc1:FplValue,loc2:FplValue) -> 
            ...
            | "inf1" -> Assert.AreEqual<string>("pred{undetermined}", inf1.Type(SignatureType.Repr))
            | "inf2" -> Assert.AreEqual<string>("pred{undetermined}", inf2.Type(SignatureType.Repr))
            | "axi1" -> Assert.AreEqual<string>("pred{true}", axi1.Type(SignatureType.Repr))
            | "axi2" -> Assert.AreEqual<string>("pred{true}", axi2.Type(SignatureType.Repr))
            | "pst1" -> Assert.AreEqual<string>("pred{true}", pst1.Type(SignatureType.Repr))
            | "pst2" -> Assert.AreEqual<string>("pred{true}", pst2.Type(SignatureType.Repr))
            | "thm1" -> Assert.AreEqual<string>("pred{true}", thm1.Type(SignatureType.Repr))
            | "thm2" -> Assert.AreEqual<string>("pred{true}", thm2.Type(SignatureType.Repr))
            | "pro1" -> Assert.AreEqual<string>("pred{true}", pro1.Type(SignatureType.Repr))
            | "pro2" -> Assert.AreEqual<string>("pred{true}", pro2.Type(SignatureType.Repr))
            | "lem1" -> Assert.AreEqual<string>("pred{true}", lem1.Type(SignatureType.Repr))
            | "lem2" -> Assert.AreEqual<string>("pred{true}", lem2.Type(SignatureType.Repr))
            | "cor1" -> Assert.AreEqual<string>("pred{true}", cor1.Type(SignatureType.Repr))
            | "cor2" -> Assert.AreEqual<string>("pred{true}", cor2.Type(SignatureType.Repr))
            | "con1" -> Assert.AreEqual<string>("pred{true}", con1.Type(SignatureType.Repr))
            | "con2" -> Assert.AreEqual<string>("pred{true}", con2.Type(SignatureType.Repr))
            ...
            | "pre1" -> Assert.AreEqual<string>("pred{true}", pre1.Type(SignatureType.Repr))
            | "pre2" -> Assert.AreEqual<string>("pred{true}", pre2.Type(SignatureType.Repr))
            | "fun1" -> Assert.AreEqual<string>("intr obj", fun1.Type(SignatureType.Repr))
            | "fun2" -> Assert.AreEqual<string>("intr obj", fun2.Type(SignatureType.Repr))
            | "prf1" -> Assert.AreEqual<string>("pred{undetermined}", prf1.Type(SignatureType.Repr))
            | "prf2" -> Assert.AreEqual<string>("pred{undetermined}", prf2.Type(SignatureType.Repr))
    ...
    member this.TestConstructors(var) =
        ...
        | Some (r,theory,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue) -> 
            ...
            | "t3" -> Assert.AreEqual<string>("obj(pred{undetermined})", t3.Type(SignatureType.Repr))
    ...
    member this.TestProofsAndCorollaries(var) =
        ...
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | "theory" -> Assert.AreEqual<string>("undef", theory.Type(SignatureType.Repr))
                | "thm1" -> Assert.AreEqual<string>("pred{true}", thm1.Type(SignatureType.Repr))
                | "proofThm1" -> Assert.AreEqual<string>("pred{undetermined}", proofThm1.Type(SignatureType.Repr))
                | "lem1" -> Assert.AreEqual<string>("pred{true}", lem1.Type(SignatureType.Repr))
                | "proofLem1" -> Assert.AreEqual<string>("pred{undetermined}", proofLem1.Type(SignatureType.Repr))
                | "prp1" -> Assert.AreEqual<string>("pred{true}", prp1.Type(SignatureType.Repr))
                | "proofPrp1" -> Assert.AreEqual<string>("pred{undetermined}", proofPrp1.Type(SignatureType.Repr))
                | "cor1" -> Assert.AreEqual<string>("pred{true}", cor1.Type(SignatureType.Repr))
                | "proofCor1" -> Assert.AreEqual<string>("pred{undetermined}", proofCor1.Type(SignatureType.Repr))
                | "thm2" -> Assert.AreEqual<string>("pred{true}", thm2.Type(SignatureType.Repr))
                | "corThm2" -> Assert.AreEqual<string>("pred{true}", corThm2.Type(SignatureType.Repr))
                | "lem2" -> Assert.AreEqual<string>("pred{true}", lem2.Type(SignatureType.Repr))
                | "corLem2" -> Assert.AreEqual<string>("pred{true}", corLem2.Type(SignatureType.Repr))
                | "prp2" -> Assert.AreEqual<string>("pred{true}", prp2.Type(SignatureType.Repr))
                | "corPrp2" -> Assert.AreEqual<string>("pred{true}", corPrp2.Type(SignatureType.Repr))
                | "cor2" -> Assert.AreEqual<string>("pred{true}", cor2.Type(SignatureType.Repr))
                | "corCor2" -> Assert.AreEqual<string>("pred{true}", corCor2.Type(SignatureType.Repr))
                | "con1" -> Assert.AreEqual<string>("pred{true}", con1.Type(SignatureType.Repr))
                | "corCon1" -> Assert.AreEqual<string>("pred{true}", corCon1.Type(SignatureType.Repr))
                | "axi1" -> Assert.AreEqual<string>("pred{true}", axi1.Type(SignatureType.Repr))
                | "corAxi1"  -> Assert.AreEqual<string>("pred{true}", corAxi1.Type(SignatureType.Repr)) 
                | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplValue,theory:FplValue,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue,t5:FplValue,t6:FplValue,t7:FplValue,t8:FplValue,t9:FplValue,t10:FplValue,t11:FplValue,t12:FplValue,
            ...
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Repr))
            | "theory" -> Assert.AreEqual<string>("undef", theory.Type(SignatureType.Repr))
            | "block" -> Assert.AreEqual<string>("pred{undetermined}", block.Type(SignatureType.Repr))
            | "t1" -> Assert.AreEqual<string>("pred{true}", t1.Type(SignatureType.Repr))
            | "t2" -> Assert.AreEqual<string>("pred{true}", t2.Type(SignatureType.Repr))
            ...
            | "t7" -> Assert.AreEqual<string>("pred{undetermined}", t7.Type(SignatureType.Repr))
            | "t8" -> Assert.AreEqual<string>("pred{undetermined}", t8.Type(SignatureType.Repr))
    ...
    member this.TestVariablesInBlock(var) =
        ...
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Repr))
            | "theory" -> Assert.AreEqual<string>("undef", theory.Type(SignatureType.Repr))
            | "block" -> Assert.AreEqual<string>("pred{true}", block.Type(SignatureType.Repr)); 
            | "x" -> Assert.AreEqual<string>("pred{undetermined}", x.Type(SignatureType.Repr))
            | "y" -> Assert.AreEqual<string>("pred{undetermined}", y.Type(SignatureType.Repr))
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>("pred{true}", base1.Type(SignatureType.Repr))
            | "base2" -> Assert.AreEqual<string>("pred{false}", base1.Type(SignatureType.Repr))
            ...
            | "base18" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base19" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base20" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base21" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base21a" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base21b" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base22" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base23" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base24" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base25" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base26" -> Assert.AreEqual<string>("pred{false}", base1.Type(SignatureType.Repr))
            ...
            | "base32" -> Assert.AreEqual<string>("undef(pred{true}, undef, pred{false})", base1.Type(SignatureType.Repr))
            | "base33" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base34" -> Assert.AreEqual<string>("pred{false}", base1.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base7" -> Assert.AreEqual<string>("undef(pred{true}, undef, pred{false})", base1.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base2" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base3" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            | "base4" -> Assert.AreEqual<string>("pred{undetermined}", base1.Type(SignatureType.Repr))
            ...
            | "base6" -> Assert.AreEqual<string>("intr obj", base1.Type(SignatureType.Repr))
            | "base7" -> Assert.AreEqual<string>("intr obj", base1.Type(SignatureType.Repr))
