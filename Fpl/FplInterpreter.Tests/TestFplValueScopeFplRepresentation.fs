...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestExpression(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base5" -> Assert.AreEqual<string>($"{literalUndef}({literalUndef})", base1.Represent())
            | "base6" -> Assert.AreEqual<string>($"$1", base1.Represent())
            | "base7" -> Assert.AreEqual<string>($"{literalUndetermined}({literalUndef}({literalUndef}))", base1.Represent())
            | "base8" -> Assert.AreEqual<string>(literalUndetermined, base1.Represent())
            | "base9" -> Assert.AreEqual<string>($"{literalUndetermined}({literalUndef})", base1.Represent())
            ...
            | "base11a" -> Assert.AreEqual<string>($"{literalUndef}.{literalUndef}", base1.Represent())
            ...
            | "base13b" -> Assert.AreEqual<string>($"1({literalUndef})", base1.Represent())
            ...
            | "base13c" -> Assert.AreEqual<string>($"1({literalUndef}, {literalUndef})", base1.Represent())
            ...
            | "base13d" -> Assert.AreEqual<string>($"1[{literalUndef}]", base1.Represent())
            ...
            | "base13e" -> Assert.AreEqual<string>($"1({literalUndef}, {literalUndef}).{literalUndef}[{literalUndef}, {literalUndef}]", base1.Represent())
            ...
            | "base13f" -> Assert.AreEqual<string>($"1[{literalUndef}].{literalUndef}({literalUndef}, {literalUndef})", base1.Represent())
            ...
            | "base16" -> Assert.AreEqual<string>($"-(*(=(+({literalUndef}, {literalUndef}), 2), {literalUndef}))", base1.Represent())
            | "base17" -> Assert.AreEqual<string>($"'(*(=(+({literalUndef}, {literalUndef}('({literalUndef}))), 2), {literalUndef}))", base1.Represent())
            ...
            | "base27" -> Assert.AreEqual<string>($"{literalUndef}({literalUndef})", base1.Represent())
