...
type TestFplValueScopeFplRepresentation() =
    ...
    //todo[<DataRow("base8", "Test$1")>]
    //todo[<DataRow("base9", "Test$1()")>]
    //todo[<DataRow("base10", "Test")>]
    //todo[<DataRow("base11", "v")>]
    //todo[<DataRow("base12", "self")>]
    //todo[<DataRow("base13", "1")>]
    //todo[<DataRow("base11a", "v.x")>]
    //todo[<DataRow("base12a", "self.x")>]
    //todo[<DataRow("base10b", "Test()")>]
    //todo[<DataRow("base11b", "v()")>]
    //todo[<DataRow("base12b", "self()")>]
    //todo[<DataRow("base13b", "1()")>]
    //todo[<DataRow("base10c", "Test(x, y)")>]
    //todo[<DataRow("base11c", "v(x, y)")>]
    //todo[<DataRow("base12c", "self(x, y)")>]
    //todo[<DataRow("base13c", "1(x, y)")>]
    //todo[<DataRow("base10d", "Test[x, y]")>]
    //todo[<DataRow("base11d", "v[x, y]")>]
    //todo[<DataRow("base12d", "self[x, y]")>]
    //todo[<DataRow("base13d", "1[x.y]")>]
    //todo[<DataRow("base10e", "Test(x, y).@self[a, b]")>]
    //todo[<DataRow("base11e", "v(x, y).x[a, b]")>]
    //todo[<DataRow("base12e", "self(x, y).3[a, b]")>]
    //todo[<DataRow("base13e", "1(x, y).T[a, b]")>]
    //todo[<DataRow("base10f", "Test[x, y].x(a, b)")>]
    //todo[<DataRow("base11f", "v[x, y].x(a, b)")>]
    //todo[<DataRow("base12f", "self[x, y].self(a, b)")>]
    //todo[<DataRow("base13f", "1[x.y].T(a, b)")>]
    //todo[<DataRow("base14", "∅")>]
    //todo[<DataRow("base15", "-x")>]
    //todo[<DataRow("base15a", "x'")>]
    //todo[<DataRow("base15b", "-x'")>]
    //todo[<DataRow("base16", "-(y + x = 2 * x)")>]
    //todo[<DataRow("base17", "(y + x' = 2 * x)'")>]
    ...
    //todo[<DataRow("base26", "is (x, Nat)")>]
    //todo[<DataRow("base27", "B()")>]
    //todo[<DataRow("base28", "C(a,b,c,d)")>]
    //todo[<DataRow("base29", "D(self,b,c)")>]
    //todo[<DataRow("base30", "B(In(x))")>]
    //todo[<DataRow("base31", "C(Test1(a),Test2(b,c,d))")>]
    //todo[<DataRow("base32", "E(true, undef, false)")>]
    //todo[<DataRow("base33", "dec ~p: pred(c: obj); p(c)")>]
    //todo[<DataRow("base34", "is(x, Set)")>]
    [<TestMethod>]
    ...
    //todo[<DataRow("base1", "base.B()")>]
    //todo[<DataRow("base2", "base.C(a, b, c, d)")>]
    //todo[<DataRow("base3", "base.D(self, a, b)")>]
    //todo[<DataRow("base4", "base.B(In(x))")>]
    //todo[<DataRow("base5", "base.C(Test1(a), Test2(b, c, d))")>]
    //todo[<DataRow("base6", "base.E(true, undef, false)")>]
    //todo[<TestMethod>]
    ...
    //todo[<DataRow("base1", "del.Equal(x,y)")>]
    ...
    //todo[<DataRow("base5", """def cl symbol "∅" T1:obj {intr};""")>]
    //todo[<DataRow("base5a", """def cl T1:obj {intr};""")>]
