...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base15" -> Assert.AreEqual<string>("undef(undef)", base1.Type(SignatureType.Repr))
            | "base15a" -> Assert.AreEqual<string>("undef(undef)", base1.Type(SignatureType.Repr))
            | "base15b" -> Assert.AreEqual<string>("undef(undef(undef))", base1.Type(SignatureType.Repr))
            | "base16" -> Assert.AreEqual<string>("undef(undef(*(=(+(undef, undef), 2), undef){undef(+(undef, undef){undef, undef}, undef), undef}))", base1.Type(SignatureType.Repr))
            | "base17" -> Assert.AreEqual<string>("undef(undef(*(=(+(undef, '(undef)), 2), undef){undef(+(undef, '(undef)){undef, undef(undef(undef))}, undef), undef}))", base1.Type(SignatureType.Repr))
