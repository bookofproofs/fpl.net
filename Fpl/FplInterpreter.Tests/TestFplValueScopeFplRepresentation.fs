...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplRoot,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,fun3:FplValue,fun4:FplValue,fun5:FplValue,fun6:FplValue,fun7:FplValue,fun8:FplValue,fun9:FplValue,prf1:FplValue,prf2:FplValue,loc1:FplValue,loc2:FplValue) -> 
            match var with 
            | "r" -> Assert.AreEqual<string>(keywUndef, getRepresentation r)
            | "theory" -> Assert.AreEqual<string>(keywUndef, getRepresentation theory)
            | "inf1" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation inf1)
            | "inf2" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation inf2)
            | "axi1" -> Assert.AreEqual<string>(keywTrue, getRepresentation axi1)
            | "axi2" -> Assert.AreEqual<string>(keywTrue, getRepresentation axi2)
            | "pst1" -> Assert.AreEqual<string>(keywTrue, getRepresentation pst1)
            | "pst2" -> Assert.AreEqual<string>(keywTrue, getRepresentation pst2)
            | "thm1" -> Assert.AreEqual<string>(keywTrue, getRepresentation thm1)
            | "thm2" -> Assert.AreEqual<string>(keywTrue, getRepresentation thm2)
            | "pro1" -> Assert.AreEqual<string>(keywTrue, getRepresentation pro1)
            | "pro2" -> Assert.AreEqual<string>(keywTrue, getRepresentation pro2)
            | "lem1" -> Assert.AreEqual<string>(keywTrue, getRepresentation lem1)
            | "lem2" -> Assert.AreEqual<string>(keywTrue, getRepresentation lem2)
            | "cor1" -> Assert.AreEqual<string>(keywTrue, getRepresentation cor1)
            | "cor2" -> Assert.AreEqual<string>(keywTrue, getRepresentation cor2)
            | "con1" -> Assert.AreEqual<string>(keywTrue, getRepresentation con1)
            | "con2" -> Assert.AreEqual<string>(keywTrue, getRepresentation con2)
            ...
            | "pre1" -> Assert.AreEqual<string>(keywTrue, getRepresentation pre1)
            | "pre2" -> Assert.AreEqual<string>(keywTrue, getRepresentation pre2)
            ...
            | "prf1" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation prf1)
            | "prf2" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation prf2)
            | "loc1" -> Assert.AreEqual<string>(keywUndef, getRepresentation loc1)
    ...
    member this.TestProofsAndCorollaries(var) =
        ...
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | "theory" -> Assert.AreEqual<string>(keywUndef, getRepresentation theory)
                | "thm1" -> Assert.AreEqual<string>(keywTrue, getRepresentation thm1)
                | "proofThm1" -> Assert.AreEqual<string>(keywTrue, getRepresentation proofThm1)
                | "lem1" -> Assert.AreEqual<string>(keywTrue, getRepresentation lem1)
                | "proofLem1" -> Assert.AreEqual<string>(keywTrue, getRepresentation proofLem1)
                | "prp1" -> Assert.AreEqual<string>(keywTrue, getRepresentation prp1)
                | "proofPrp1" -> Assert.AreEqual<string>(keywTrue, getRepresentation proofPrp1)
                | "cor1" -> Assert.AreEqual<string>(keywTrue, getRepresentation cor1)
                | "proofCor1" -> Assert.AreEqual<string>(keywTrue, getRepresentation proofCor1)
                | "thm2" -> Assert.AreEqual<string>(keywTrue, getRepresentation thm2)
                | "corThm2" -> Assert.AreEqual<string>(keywTrue, getRepresentation corThm2)
                | "lem2" -> Assert.AreEqual<string>(keywTrue, getRepresentation lem2)
                | "corLem2" -> Assert.AreEqual<string>(keywTrue, getRepresentation corLem2)
                | "prp2" -> Assert.AreEqual<string>(keywTrue, getRepresentation prp2)
                | "corPrp2" -> Assert.AreEqual<string>(keywTrue, getRepresentation corPrp2)
                | "cor2" -> Assert.AreEqual<string>(keywTrue, getRepresentation cor2)
                | "corCor2" -> Assert.AreEqual<string>(keywTrue, getRepresentation corCor2)
                | "con1" -> Assert.AreEqual<string>(keywTrue, getRepresentation con1)
                | "corCon1" -> Assert.AreEqual<string>(keywTrue, getRepresentation corCon1)
                | "axi1" -> Assert.AreEqual<string>(keywTrue, getRepresentation axi1)
                | "corAxi1"  -> Assert.AreEqual<string>(keywTrue, getRepresentation corAxi1) 
                | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplRoot,theory:FplValue,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue,t5:FplValue,t6:FplValue,t7:FplValue,t8:FplValue,t9:FplValue,t10:FplValue,t11:FplValue,t12:FplValue,
            ...
            | "r" -> Assert.AreEqual<string>(keywUndef, getRepresentation r)
            | "theory" -> Assert.AreEqual<string>(keywUndef, getRepresentation theory)
            | "block" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation block)
            | "t1" -> Assert.AreEqual<string>(keywTrue, getRepresentation t1)
            | "t2" -> Assert.AreEqual<string>(keywTrue, getRepresentation t2)
            | "t3" -> Assert.AreEqual<string>("dec obj", getRepresentation t3)
            | "t4" -> Assert.AreEqual<string>("dec obj", getRepresentation t4)
            | "t5" -> Assert.AreEqual<string>(keywInd, getRepresentation t5)
            | "t6" -> Assert.AreEqual<string>(keywInd, getRepresentation t6)
            | "t7" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation t7)
            | "t8" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation t8)
    ...
    member this.TestVariablesInBlock(var) =
        ...
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "r" -> Assert.AreEqual<string>(keywUndef, getRepresentation r)
            | "theory" -> Assert.AreEqual<string>(keywUndef, getRepresentation theory)
            | "block" -> Assert.AreEqual<string>(keywTrue, getRepresentation block); 
    ...
    member this.TestExpression(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>(keywTrue, getRepresentation pr1)
            | "base2" -> Assert.AreEqual<string>(keywFalse, getRepresentation base1)
            | "base3" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base4" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            ...
            | "base8" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base9" -> Assert.AreEqual<string>("undetermined(undef)", getRepresentation base1)
            | "base10" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base11" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base13" -> Assert.AreEqual<string>("1", getRepresentation base1)
            | "base11a" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12a" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base10b" -> Assert.AreEqual<string>("undef(undef)", getRepresentation base1)
            | "base11b" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12b" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            ...
            | "base11c" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12c" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            ...
            | "base11d" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12d" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            ...
            | "base11e" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12e" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            ...
            | "base11f" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base12f" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            | "base13f" -> Assert.AreEqual<string>("1[undef].undef(undef, undef)", getRepresentation base1)
            | "base14" -> Assert.AreEqual<string>(keywUndef, getRepresentation base1)
            ...
            | "base18" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base19" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base20" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base21" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base21a" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base21b" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base22" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base23" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base24" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base25" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base26" -> Assert.AreEqual<string>(keywFalse, getRepresentation base1)
            ...
            | "base33" -> Assert.AreEqual<string>(keywUndetermined, getRepresentation base1)
            | "base34" -> Assert.AreEqual<string>(keywFalse, getRepresentation base1)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
