...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestExpression(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base7" -> Assert.AreEqual<string>("undetermined(undef(undef))", base1.Represent())
            | "base8" -> Assert.AreEqual<string>(literalUndetermined, base1.Represent())
            | "base9" -> Assert.AreEqual<string>("undetermined(undef)", base1.Represent())
            ...
            | "base10b" -> Assert.AreEqual<string>("undef(undef)", base1.Represent())
            | "base11b" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base12b" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base13b" -> Assert.AreEqual<string>("1(undef)", base1.Represent())
            | "base10c" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Represent())
            | "base11c" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base12c" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base13c" -> Assert.AreEqual<string>("1(undef, undef)", base1.Represent())
            | "base10d" -> Assert.AreEqual<string>("undef[undef, undef]", base1.Represent())
            | "base11d" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base12d" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base13d" -> Assert.AreEqual<string>("1[undef]", base1.Represent())
            | "base10e" -> Assert.AreEqual<string>("undef(undef, undef).undef[undef, undef]", base1.Represent())
            | "base11e" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base12e" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base13e" -> Assert.AreEqual<string>("1(undef, undef).undef[undef, undef]", base1.Represent())
            | "base10f" -> Assert.AreEqual<string>("undef[undef, undef].undef", base1.Represent())
            | "base11f" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base12f" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base13f" -> Assert.AreEqual<string>("1[undef].undef(undef, undef)", base1.Represent())
            | "base14" -> Assert.AreEqual<string>(literalUndef, base1.Represent())
            | "base15" -> Assert.AreEqual<string>("-(undef)", base1.Represent())
            | "base15a" -> Assert.AreEqual<string>("'(undef)", base1.Represent())
            | "base15b" -> Assert.AreEqual<string>("'(-(undef))", base1.Represent())
            | "base16" -> Assert.AreEqual<string>("-(*(=(+(undef, undef), 2), undef))", base1.Represent())
            | "base17" -> Assert.AreEqual<string>("'(*(=(+(undef, undef('(undef))), 2), undef))", base1.Represent())
            ...
            | "base27" -> Assert.AreEqual<string>("undef(undef)", base1.Represent())
            | "base28" -> Assert.AreEqual<string>("undef(undef, undef, undef, undef)", base1.Represent())
            | "base29" -> Assert.AreEqual<string>("undef(undef, undef, undef)", base1.Represent())
            | "base30" -> Assert.AreEqual<string>("undef(undef(undef))", base1.Represent())
            | "base31" -> Assert.AreEqual<string>("undef(undef(undef), undef(undef, undef, undef))", base1.Represent())
            | "base32" -> Assert.AreEqual<string>("undef(true, undef, false)", base1.Represent())
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Represent())
