...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue,loc1:FplValue,loc2:FplValue) -> 
            ...
            | "cla1" -> Assert.AreEqual<string>("class SomeClass1:obj", cla1.Type(SignatureType.Repr))
            | "cla2" -> Assert.AreEqual<string>("class SomeClass2:obj", cla2.Type(SignatureType.Repr))
            ...
            | "fun1" -> Assert.AreEqual<string>("obj", fun1.Type(SignatureType.Repr))
            | "fun2" -> Assert.AreEqual<string>("obj", fun2.Type(SignatureType.Repr))
            ...
            | "loc2" -> Assert.AreEqual<string>("undef", loc2.Type(SignatureType.Repr))
    ...
    member this.TestConstructors(var) =
        ...
        | Some (r,theory,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue) -> 
            ...
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Repr))
            | "theory" -> Assert.AreEqual<string>("undef", theory.Type(SignatureType.Repr))
            | "block" -> Assert.AreEqual<string>("obj:class TestId", block.Type(SignatureType.Repr))
            | "t1" -> Assert.AreEqual<string>("obj", t1.Type(SignatureType.Repr))
            | "t2" -> Assert.AreEqual<string>("obj", t2.Type(SignatureType.Repr))
            | "t3" -> Assert.AreEqual<string>("obj", t3.Type(SignatureType.Repr))
            | "t4" -> Assert.AreEqual<string>("obj", t4.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestProofsAndCorollaries(var) =
        ...
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | "theory" -> Assert.AreEqual<string>("undef", theory.Type(SignatureType.Repr))
                | "thm1" -> Assert.AreEqual<string>("true", thm1.Type(SignatureType.Repr))
                | "proofThm1" -> Assert.AreEqual<string>("true", proofThm1.Type(SignatureType.Repr))
                | "lem1" -> Assert.AreEqual<string>("true", lem1.Type(SignatureType.Repr))
                | "proofLem1" -> Assert.AreEqual<string>("true", proofLem1.Type(SignatureType.Repr))
                | "prp1" -> Assert.AreEqual<string>("true", prp1.Type(SignatureType.Repr))
                | "proofPrp1" -> Assert.AreEqual<string>("true", proofPrp1.Type(SignatureType.Repr))
                | "cor1" -> Assert.AreEqual<string>("true", cor1.Type(SignatureType.Repr))
                | "proofCor1" -> Assert.AreEqual<string>("true", proofCor1.Type(SignatureType.Repr))
                | "thm2" -> Assert.AreEqual<string>("true", thm2.Type(SignatureType.Repr))
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplValue,theory:FplValue,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue,t5:FplValue,t6:FplValue,t7:FplValue,t8:FplValue,t9:FplValue,t10:FplValue,t11:FplValue,t12:FplValue,
            ...
            | "t9" -> Assert.AreEqual<string>("obj", t9.Type(SignatureType.Repr))
            | "t10" -> Assert.AreEqual<string>("obj", t10.Type(SignatureType.Repr))
            | "t11" -> Assert.AreEqual<string>("obj", t11.Type(SignatureType.Repr))
            | "t12" -> Assert.AreEqual<string>("obj", t12.Type(SignatureType.Repr))
    ...
    member this.TestVariablesInBlock(var) =
        ...
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "xu" -> Assert.AreEqual<string>("intr obj", xu.Type(SignatureType.Repr))
            | "xv" -> Assert.AreEqual<string>("intr obj", xv.Type(SignatureType.Repr))
            | "xw" -> Assert.AreEqual<string>("intr obj", xw.Type(SignatureType.Repr))
            | "yu" -> Assert.AreEqual<string>("intr obj", yu.Type(SignatureType.Repr))
            | "yv" -> Assert.AreEqual<string>("intr obj", yv.Type(SignatureType.Repr))
            | "yw" -> Assert.AreEqual<string>("intr obj", yw.Type(SignatureType.Repr))
            | "xua" -> Assert.AreEqual<string>("intr obj", xua.Type(SignatureType.Repr))
            | "xub" -> Assert.AreEqual<string>("intr obj", xub.Type(SignatureType.Repr))
            | "xuc" -> Assert.AreEqual<string>("intr obj", xuc.Type(SignatureType.Repr))
            | "xva" -> Assert.AreEqual<string>("intr obj", xva.Type(SignatureType.Repr))
            | "xvb" -> Assert.AreEqual<string>("intr obj", xvb.Type(SignatureType.Repr))
            | "xvc" -> Assert.AreEqual<string>("intr obj", xvc.Type(SignatureType.Repr))
            | "xwa" -> Assert.AreEqual<string>("intr obj", xwa.Type(SignatureType.Repr))
            | "xwb" -> Assert.AreEqual<string>("intr obj", xwb.Type(SignatureType.Repr))
            | "xwc" -> Assert.AreEqual<string>("intr obj", xwc.Type(SignatureType.Repr))
            | "yua" -> Assert.AreEqual<string>("intr obj", yua.Type(SignatureType.Repr))
            | "yub" -> Assert.AreEqual<string>("intr obj", yub.Type(SignatureType.Repr))
            | "yuc" -> Assert.AreEqual<string>("intr obj", yuc.Type(SignatureType.Repr))
            | "yva" -> Assert.AreEqual<string>("intr obj", yva.Type(SignatureType.Repr))
            | "yvb" -> Assert.AreEqual<string>("intr obj", yvb.Type(SignatureType.Repr))
            | "yvc" -> Assert.AreEqual<string>("intr obj", yvc.Type(SignatureType.Repr))
            | "ywa" -> Assert.AreEqual<string>("intr obj", ywa.Type(SignatureType.Repr))
            | "ywb" -> Assert.AreEqual<string>("intr obj", ywb.Type(SignatureType.Repr))
            | "ywc" -> Assert.AreEqual<string>("intr obj", ywc.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestVariablesInBlockVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "yv" -> Assert.AreEqual<string>("intr obj", yv.Type(SignatureType.Repr))
            | "yw" -> Assert.AreEqual<string>("intr obj", yw.Type(SignatureType.Repr))
            | "xua" -> Assert.AreEqual<string>("*obj{obj}", xua.Type(SignatureType.Repr))
            | "xub" -> Assert.AreEqual<string>("*obj{obj}", xub.Type(SignatureType.Repr))
            | "xuc" -> Assert.AreEqual<string>("*obj{obj}", xuc.Type(SignatureType.Repr))
            | "xva" -> Assert.AreEqual<string>("*obj{obj}", xva.Type(SignatureType.Repr))
            | "xvb" -> Assert.AreEqual<string>("*obj{obj}", xvb.Type(SignatureType.Repr))
            | "xvc" -> Assert.AreEqual<string>("*obj{obj}", xvc.Type(SignatureType.Repr))
            | "xwa" -> Assert.AreEqual<string>("*obj{obj}", xwa.Type(SignatureType.Repr))
            | "xwb" -> Assert.AreEqual<string>("*obj{obj}", xwb.Type(SignatureType.Repr))
            | "xwc" -> Assert.AreEqual<string>("*obj{obj}", xwc.Type(SignatureType.Repr))
            | "yua" -> Assert.AreEqual<string>("*obj{obj}", yua.Type(SignatureType.Repr))
            | "yub" -> Assert.AreEqual<string>("*obj{obj}", yub.Type(SignatureType.Repr))
            | "yuc" -> Assert.AreEqual<string>("*obj{obj}", yuc.Type(SignatureType.Repr))
            | "yva" -> Assert.AreEqual<string>("*obj{obj}", yva.Type(SignatureType.Repr))
            | "yvb" -> Assert.AreEqual<string>("*obj{obj}", yvb.Type(SignatureType.Repr))
            | "yvc" -> Assert.AreEqual<string>("*obj{obj}", yvc.Type(SignatureType.Repr))
            | "ywa" -> Assert.AreEqual<string>("*obj{obj}", ywa.Type(SignatureType.Repr))
            | "ywb" -> Assert.AreEqual<string>("*obj{obj}", ywb.Type(SignatureType.Repr))
            | "ywc" -> Assert.AreEqual<string>("*obj{obj}", ywc.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base5" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base6" -> Assert.AreEqual<string>("1", base1.Type(SignatureType.Repr))
            | "base7" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base8" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base9" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base10" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base11" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base13" -> Assert.AreEqual<string>("extension", base1.Type(SignatureType.Repr))
            | "base11a" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12a" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base10b" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base11b" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12b" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base13b" -> Assert.AreEqual<string>("undef(undef)", base1.Type(SignatureType.Repr))
            | "base10c" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base11c" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12c" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base13c" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Type(SignatureType.Repr))
            | "base10d" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base11d" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12d" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base13d" -> Assert.AreEqual<string>("undef[undef]", base1.Type(SignatureType.Repr))
            | "base10e" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base11e" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12e" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base13e" -> Assert.AreEqual<string>("undef(undef, undef).undef[undef, undef]", base1.Type(SignatureType.Repr))
            | "base10f" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base11f" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base12f" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base13f" -> Assert.AreEqual<string>("undef[undef].undef(undef, undef)", base1.Type(SignatureType.Repr))
            | "base14" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base15" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base15a" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base15b" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base16" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base17" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            ...
            | "base26" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base27" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base28" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base29" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base30" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base31" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            | "base32" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
    ...
    member this.TestCallConstructorParentClass(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual<string>("obj", base1.Type(SignatureType.Repr))
            | "base2" -> Assert.AreEqual<string>("obj", base1.Type(SignatureType.Repr))
            | "base3" -> Assert.AreEqual<string>("obj", base1.Type(SignatureType.Repr))
            | "base4" -> Assert.AreEqual<string>("obj", base1.Type(SignatureType.Repr))
            | "base5" -> Assert.AreEqual<string>("obj", base1.Type(SignatureType.Repr))
            | "base6" -> Assert.AreEqual<string>("obj", base1.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base2" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base3" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base4" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base5" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base6" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | "base7" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base5" -> Assert.AreEqual<string>("class T1:obj", base1.Type(SignatureType.Repr))
            | "base5a" -> Assert.AreEqual<string>("class T1:obj", base1.Type(SignatureType.Repr))
            | "base6" -> Assert.AreEqual<string>(":obj", base1.Type(SignatureType.Repr))
            | "base7" -> Assert.AreEqual<string>(":obj", base1.Type(SignatureType.Repr))
            | "base8" -> Assert.AreEqual<string>(":obj", base1.Type(SignatureType.Repr))
            | "base9" -> Assert.AreEqual<string>(":obj", base1.Type(SignatureType.Repr))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
