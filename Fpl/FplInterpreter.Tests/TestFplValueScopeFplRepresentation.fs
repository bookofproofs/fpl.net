...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplValue,theory:FplValue,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue,t5:FplValue,t6:FplValue,t7:FplValue,t8:FplValue,t9:FplValue,t10:FplValue,t11:FplValue,t12:FplValue,
            ...
            | "t3" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.ObjRepr "obj", t3.FplRepresentation)
            | "t4" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.ObjRepr "obj", t4.FplRepresentation)
            | "t5" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.Index 0, t5.FplRepresentation)
            | "t6" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.Index 0, t6.FplRepresentation)
            ...
            | "t11" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.ObjRepr "Nat", t11.FplRepresentation)
            | "t12" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.ObjRepr "Nat", t12.FplRepresentation)
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base6" -> Assert.AreEqual<FplRepresentation>(FplRepresentation.Index 1, base1.FplRepresentation)
