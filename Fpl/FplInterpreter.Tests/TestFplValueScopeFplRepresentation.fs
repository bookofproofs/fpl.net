...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue,loc1:FplValue,loc2:FplValue) -> 
            ...
            | "axi1" -> Assert.AreEqual<string>("undetermined", axi1.Type(SignatureType.Repr))
            | "axi2" -> Assert.AreEqual<string>("undetermined", axi2.Type(SignatureType.Repr))
            | "pst1" -> Assert.AreEqual<string>("undetermined", pst1.Type(SignatureType.Repr))
            | "pst2" -> Assert.AreEqual<string>("undetermined", pst2.Type(SignatureType.Repr))
            | "thm1" -> Assert.AreEqual<string>("undetermined", thm1.Type(SignatureType.Repr))
            | "thm2" -> Assert.AreEqual<string>("undetermined", thm2.Type(SignatureType.Repr))
            | "pro1" -> Assert.AreEqual<string>("undetermined", pro1.Type(SignatureType.Repr))
            | "pro2" -> Assert.AreEqual<string>("undetermined", pro2.Type(SignatureType.Repr))
            | "lem1" -> Assert.AreEqual<string>("undetermined", lem1.Type(SignatureType.Repr))
            | "lem2" -> Assert.AreEqual<string>("undetermined", lem2.Type(SignatureType.Repr))
            | "cor1" -> Assert.AreEqual<string>("undetermined", cor1.Type(SignatureType.Repr))
            | "cor2" -> Assert.AreEqual<string>("undetermined", cor2.Type(SignatureType.Repr))
            | "con1" -> Assert.AreEqual<string>("undetermined", con1.Type(SignatureType.Repr))
            | "con2" -> Assert.AreEqual<string>("undetermined", con2.Type(SignatureType.Repr))
            ...
            | "pre1" -> Assert.AreEqual<string>("undetermined", pre1.Type(SignatureType.Repr))
            | "pre2" -> Assert.AreEqual<string>("undetermined", pre2.Type(SignatureType.Repr))
    ...
    member this.TestProofsAndCorollaries(var) =
        ...
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | "prp1" -> Assert.AreEqual<string>("undetermined", prp1.Type(SignatureType.Repr))
                ...
                | "thm2" -> Assert.AreEqual<string>("undetermined", thm2.Type(SignatureType.Repr))
                | "corThm2" -> Assert.AreEqual<string>("undetermined", corThm2.Type(SignatureType.Repr))
                | "lem2" -> Assert.AreEqual<string>("undetermined", lem2.Type(SignatureType.Repr))
                | "corLem2" -> Assert.AreEqual<string>("undetermined", corLem2.Type(SignatureType.Repr))
                | "prp2" -> Assert.AreEqual<string>("undetermined", prp2.Type(SignatureType.Repr))
                | "corPrp2" -> Assert.AreEqual<string>("undetermined", corPrp2.Type(SignatureType.Repr))
                | "cor2" -> Assert.AreEqual<string>("undetermined", cor2.Type(SignatureType.Repr))
                | "corCor2" -> Assert.AreEqual<string>("undetermined", corCor2.Type(SignatureType.Repr))
                | "con1" -> Assert.AreEqual<string>("undetermined", con1.Type(SignatureType.Repr))
                | "corCon1" -> Assert.AreEqual<string>("undetermined", corCon1.Type(SignatureType.Repr))
                | "axi1" -> Assert.AreEqual<string>("undetermined", axi1.Type(SignatureType.Repr))
                | "corAxi1"  -> Assert.AreEqual<string>("undetermined", corAxi1.Type(SignatureType.Repr)) 
                | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplValue,theory:FplValue,block:FplValue,t1:FplValue,t2:FplValue,t3:FplValue,t4:FplValue,t5:FplValue,t6:FplValue,t7:FplValue,t8:FplValue,t9:FplValue,t10:FplValue,t11:FplValue,t12:FplValue,
            ...
            | "t1" -> Assert.AreEqual<string>("undetermined", t1.Type(SignatureType.Repr))
            | "t2" -> Assert.AreEqual<string>("undetermined", t2.Type(SignatureType.Repr))
            | "t3" -> Assert.AreEqual<string>("obj", t3.Type(SignatureType.Repr))
            | "t4" -> Assert.AreEqual<string>("obj", t4.Type(SignatureType.Repr))
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base13b" -> Assert.AreEqual<string>("extension", base1.Type(SignatureType.Repr))
            ...
            | "base13c" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            ...
            | "base13d" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            ...
            | "base13e" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
            ...
            | "base13f" -> Assert.AreEqual<string>("undetermined", base1.Type(SignatureType.Repr))
