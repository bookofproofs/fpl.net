...
type TestFplValueScopeFplRepresentation() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base13" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            ...
            | "base10b" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            ...
            | "base10c" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            ...
            | "base10d" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            ...
            | "base10e" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
            ...
            | "base10f" -> Assert.AreEqual<string>("undef", base1.Type(SignatureType.Repr))
