...
type TestFplValueScopeNameEndPos() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual((int64)22, base1.NameEndPos.Column)
            | "base2" -> Assert.AreEqual((int64)23, base1.NameEndPos.Column)
            | "base3" -> Assert.AreEqual((int64)23, base1.NameEndPos.Column)
            | "base4" -> Assert.AreEqual((int64)19, base1.NameEndPos.Column)
            | "base5" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base6" -> Assert.AreEqual((int64)19, base1.NameEndPos.Column)
            | "base7" -> Assert.AreEqual((int64)29, base1.NameEndPos.Column)
            | "base8" -> Assert.AreEqual((int64)24, base1.NameEndPos.Column)
            | "base9" -> Assert.AreEqual((int64)26, base1.NameEndPos.Column)
            | "base10" -> Assert.AreEqual((int64)21, base1.NameEndPos.Column)
            | "base11" -> Assert.AreEqual((int64)18, base1.NameEndPos.Column)
            | "base12" -> Assert.AreEqual((int64)22, base1.NameEndPos.Column)
            | "base13" -> Assert.AreEqual((int64)18, base1.NameEndPos.Column)
            | "base11a" -> Assert.AreEqual((int64)20, base1.NameEndPos.Column)
            | "base12a" -> Assert.AreEqual((int64)23, base1.NameEndPos.Column)
            | "base10b" -> Assert.AreEqual((int64)23, base1.NameEndPos.Column)
            | "base11b" -> Assert.AreEqual((int64)20, base1.NameEndPos.Column)
            | "base12b" -> Assert.AreEqual((int64)23, base1.NameEndPos.Column)
            | "base13b" -> Assert.AreEqual((int64)20, base1.NameEndPos.Column)
            | "base10c" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base11c" -> Assert.AreEqual((int64)24, base1.NameEndPos.Column)
            | "base12c" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base13c" -> Assert.AreEqual((int64)24, base1.NameEndPos.Column)
            | "base10d" -> Assert.AreEqual((int64)28, base1.NameEndPos.Column)
            | "base11d" -> Assert.AreEqual((int64)25, base1.NameEndPos.Column)
            | "base12d" -> Assert.AreEqual((int64)28, base1.NameEndPos.Column)
            | "base13d" -> Assert.AreEqual((int64)24, base1.NameEndPos.Column)
            | "base10e" -> Assert.AreEqual((int64)40, base1.NameEndPos.Column)
            | "base11e" -> Assert.AreEqual((int64)33, base1.NameEndPos.Column)
            | "base12e" -> Assert.AreEqual((int64)36, base1.NameEndPos.Column)
            | "base13e" -> Assert.AreEqual((int64)33, base1.NameEndPos.Column)
            | "base10f" -> Assert.AreEqual((int64)35, base1.NameEndPos.Column)
            | "base11f" -> Assert.AreEqual((int64)32, base1.NameEndPos.Column)
            | "base12f" -> Assert.AreEqual((int64)38, base1.NameEndPos.Column)
            | "base13f" -> Assert.AreEqual((int64)31, base1.NameEndPos.Column)
            | "base14" -> Assert.AreEqual((int64)19, base1.NameEndPos.Column)
            | "base15" -> Assert.AreEqual((int64)19, base1.NameEndPos.Column)
            | "base15a" -> Assert.AreEqual((int64)20, base1.NameEndPos.Column)
            | "base15b" -> Assert.AreEqual((int64)21, base1.NameEndPos.Column)
            | "base16" -> Assert.AreEqual((int64)33, base1.NameEndPos.Column)
            | "base17" -> Assert.AreEqual((int64)35, base1.NameEndPos.Column)
            | "base18" -> Assert.AreEqual((int64)64, base1.NameEndPos.Column)
            | "base19" -> Assert.AreEqual((int64)40, base1.NameEndPos.Column)
            | "base20" -> Assert.AreEqual((int64)31, base1.NameEndPos.Column)
            | "base21" -> Assert.AreEqual((int64)30, base1.NameEndPos.Column)
            | "base21a" -> Assert.AreEqual((int64)23, base1.NameEndPos.Column)
            | "base21b" -> Assert.AreEqual((int64)25, base1.NameEndPos.Column)
            | "base22" -> Assert.AreEqual((int64)30, base1.NameEndPos.Column)
            | "base23" -> Assert.AreEqual((int64)29, base1.NameEndPos.Column)
            | "base24" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base25" -> Assert.AreEqual((int64)28, base1.NameEndPos.Column)
            | "base26" -> Assert.AreEqual((int64)28, base1.NameEndPos.Column)
            | "base27" -> Assert.AreEqual((int64)20, base1.NameEndPos.Column)
            | "base28" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base29" -> Assert.AreEqual((int64)28, base1.NameEndPos.Column)
            | "base30" -> Assert.AreEqual((int64)25, base1.NameEndPos.Column)
            | "base31" -> Assert.AreEqual((int64)41, base1.NameEndPos.Column)
            | "base32" -> Assert.AreEqual((int64)38, base1.NameEndPos.Column)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestCallConstructorParentClass(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual((int64)1, base1.NameEndPos.Column)
            | "base2" -> Assert.AreEqual((int64)1, base1.NameEndPos.Column)
            | "base3" -> Assert.AreEqual((int64)1, base1.NameEndPos.Column)
            | "base4" -> Assert.AreEqual((int64)1, base1.NameEndPos.Column)
            | "base5" -> Assert.AreEqual((int64)1, base1.NameEndPos.Column)
            | "base6" -> Assert.AreEqual((int64)1, base1.NameEndPos.Column)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual((int64)24, base1.NameEndPos.Column)
            | "base2" -> Assert.AreEqual((int64)31, base1.NameEndPos.Column)
            | "base3" -> Assert.AreEqual((int64)32, base1.NameEndPos.Column)
            | "base4" -> Assert.AreEqual((int64)29, base1.NameEndPos.Column)
            | "base5" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base6" -> Assert.AreEqual((int64)45, base1.NameEndPos.Column)
            | "base7" -> Assert.AreEqual((int64)42, base1.NameEndPos.Column)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual((int64)14, base1.NameEndPos.Column)
            | "base2" -> Assert.AreEqual((int64)27, base1.NameEndPos.Column)
            | "base3" -> Assert.AreEqual((int64)26, base1.NameEndPos.Column)
            | "base4" -> Assert.AreEqual((int64)25, base1.NameEndPos.Column)
            | "base5" -> Assert.AreEqual((int64)21, base1.NameEndPos.Column)
            | "base5a" -> Assert.AreEqual((int64)10, base1.NameEndPos.Column)
            | "base6" -> Assert.AreEqual((int64)19, base1.NameEndPos.Column)
            | "base7" -> Assert.AreEqual((int64)32, base1.NameEndPos.Column)
            | "base8" -> Assert.AreEqual((int64)31, base1.NameEndPos.Column)
            | "base9" -> Assert.AreEqual((int64)30, base1.NameEndPos.Column)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
