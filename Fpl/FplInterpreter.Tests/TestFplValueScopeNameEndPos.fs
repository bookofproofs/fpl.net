...
type TestFplValueScopeNameEndPos() =
    ...
    member this.TestVariablesInBlockVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "xu" -> Assert.AreEqual<int64>(61L, xu.EndPos.Column)
            | "xv" -> Assert.AreEqual<int64>(61L, xv.EndPos.Column)
            | "xw" -> Assert.AreEqual<int64>(61L, xw.EndPos.Column)
            | "yu" -> Assert.AreEqual<int64>(61L, yu.EndPos.Column)
            | "yv" -> Assert.AreEqual<int64>(61L, yv.EndPos.Column)
            | "yw" -> Assert.AreEqual<int64>(61L, yw.EndPos.Column)
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "x" -> Assert.AreEqual<int64>(33L, x.EndPos.Column)
            | "y" -> Assert.AreEqual<int64>(35L, y.EndPos.Column)
            | "xu" -> Assert.AreEqual<int64>(74L, xu.EndPos.Column)
            | "xv" -> Assert.AreEqual<int64>(74L, xv.EndPos.Column)
            | "xw" -> Assert.AreEqual<int64>(74L, xw.EndPos.Column)
            | "yu" -> Assert.AreEqual<int64>(74L, yu.EndPos.Column)
            | "yv" -> Assert.AreEqual<int64>(74L, yv.EndPos.Column)
            | "yw" -> Assert.AreEqual<int64>(74L, yw.EndPos.Column)
