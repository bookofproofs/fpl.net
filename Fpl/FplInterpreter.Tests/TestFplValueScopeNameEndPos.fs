...
type TestFplValueScopeNameEndPos() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base13" -> Assert.AreEqual<int64>((int64)19, base1.NameEndPos.Column)
            ...
            | "base13b" -> Assert.AreEqual<int64>((int64)21, base1.NameEndPos.Column)
            ...
            | "base13c" -> Assert.AreEqual<int64>((int64)25, base1.NameEndPos.Column)
            ...
            | "base13d" -> Assert.AreEqual<int64>((int64)25, base1.NameEndPos.Column)
            ...
            | "base12e" -> Assert.AreEqual<int64>((int64)37, base1.NameEndPos.Column)
            | "base13e" -> Assert.AreEqual<int64>((int64)34, base1.NameEndPos.Column)
            ...
            | "base13f" -> Assert.AreEqual<int64>((int64)32, base1.NameEndPos.Column)
            ...
            | "base16" -> Assert.AreEqual<int64>((int64)34, base1.NameEndPos.Column)
            | "base17" -> Assert.AreEqual<int64>((int64)36, base1.NameEndPos.Column)
            ...
            | "base21" -> Assert.AreEqual<int64>((int64)35, base1.NameEndPos.Column)
            ...
            | "base22" -> Assert.AreEqual<int64>((int64)35, base1.NameEndPos.Column)
            | "base23" -> Assert.AreEqual<int64>((int64)33, base1.NameEndPos.Column)
