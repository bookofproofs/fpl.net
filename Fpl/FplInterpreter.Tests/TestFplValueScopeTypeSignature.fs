...
type TestFplValueScopeTypeSignature() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue) -> 
            ...
            | "cor1" -> Assert.AreEqual(["SomeLemma1"; "ind"; "("; ")"], cor1.TypeSignature)
            | "cor2" -> Assert.AreEqual(["SomeLemma2"; "ind"; "("; ")"], cor2.TypeSignature)
            ...
            | "prf1" -> Assert.AreEqual(["SomeTheorem1"; "ind"], prf1.TypeSignature)
            | "prf2" -> Assert.AreEqual(["SomeTheorem2"; "ind"], prf2.TypeSignature)
    ...
    member this.TestProofsAndCorollaries(var) =
        ...
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | "proofThm1" -> Assert.AreEqual(["TestTheorem1"; "ind"], proofThm1.TypeSignature)
                | "lem1" -> Assert.AreEqual(["TestLemma1"; "("; ")"], lem1.TypeSignature)
                | "proofLem1" -> Assert.AreEqual(["TestLemma1"; "ind"], proofLem1.TypeSignature)
                | "prp1" -> Assert.AreEqual(["TestProposition1"; "("; ")"], prp1.TypeSignature)
                | "proofPrp1" -> Assert.AreEqual(["TestProposition1"; "ind"], proofPrp1.TypeSignature)
                | "cor1" -> Assert.AreEqual(["TestCorollary1"; "ind"; "("; ")"], cor1.TypeSignature)
                | "proofCor1" -> Assert.AreEqual(["TestCorollary1"; "ind"; "ind"], proofCor1.TypeSignature)
                | "thm2" -> Assert.AreEqual(["TestTheorem2"; "("; ")"], thm2.TypeSignature)
                | "corThm2" -> Assert.AreEqual(["TestTheorem2"; "ind"; "("; ")"], corThm2.TypeSignature)
                | "lem2" -> Assert.AreEqual(["TestLemma2"; "("; ")"], lem2.TypeSignature)
                | "corLem2" -> Assert.AreEqual(["TestLemma2"; "ind"; "("; ")"], corLem2.TypeSignature)
                | "prp2" -> Assert.AreEqual(["TestProposition2"; "("; ")"], prp2.TypeSignature)
                | "corPrp2" -> Assert.AreEqual(["TestProposition2"; "ind"; "("; ")"], corPrp2.TypeSignature)
                | "cor2" -> Assert.AreEqual(["TestCorollary2"; "ind"; "("; ")"], cor2.TypeSignature)
                | "corCor2" -> Assert.AreEqual(["TestCorollary2"; "ind"; "ind"; "("; ")"], corCor2.TypeSignature)
                | "con1" -> Assert.AreEqual(["TestConjecture"; "("; ")"], con1.TypeSignature)
                | "corCon1" -> Assert.AreEqual(["TestConjecture"; "ind"; "("; ")"], corCon1.TypeSignature)
                | "axi1" -> Assert.AreEqual(["TestAxiom"; "("; ")"], axi1.TypeSignature)
                | "corAxi1"  -> Assert.AreEqual(["TestAxiom"; "ind"; "("; ")"], corAxi1.TypeSignature) 
                | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base15a" -> Assert.AreEqual(["'"; "("; "undef"; ")"], base1.TypeSignature)
            | "base15b" -> Assert.AreEqual(["'"; "("; "-"; "("; "undef"; ")"; ")"], base1.TypeSignature)
            | "base16" -> Assert.AreEqual(["-"; "("; "+"; "("; "undef"; "="; "("; "undef"; "*"; "("; "2"; "undef"; ")"; ")"; ")"; ")"], base1.TypeSignature)
            | "base17" -> Assert.AreEqual(["'"; "("; "+"; "("; "undef"; "="; "("; "'"; "("; "undef"; ")"; "*"; "("; "2"; "undef"; ")"; ")"; ")"; ")"], base1.TypeSignature)
    ...
    member this.TestCallConstructorParentClass(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual(["B"; "("; ")"], base1.TypeSignature)
            | "base2" -> Assert.AreEqual(["C"; "("; "undef"; "undef"; "undef"; "undef"; ")"], base1.TypeSignature)
            | "base3" -> Assert.AreEqual(["D"; "("; "self"; "undef"; "undef"; ")"], base1.TypeSignature)
            | "base4" -> Assert.AreEqual(["B"; "("; "In"; "("; "undef"; ")"; ")"], base1.TypeSignature)
            | "base5" -> Assert.AreEqual(["C"; "("; "Test1"; "("; "undef"; ")"; "Test2"; "("; "undef"; "undef"; "undef"; ")"; ")"], base1.TypeSignature)
            | "base6" -> Assert.AreEqual(["E"; "("; "pred"; "undef"; "pred"; ")"], base1.TypeSignature)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual(["del."; "B"; "("; ")"], base1.TypeSignature)
            | "base2" -> Assert.AreEqual(["del."; "C"; "("; "undef"; "undef"; "undef"; "undef"; ")"], base1.TypeSignature)
            | "base3" -> Assert.AreEqual(["del."; "D"; "("; "self"; "undef"; "undef"; ")"], base1.TypeSignature)
            | "base4" -> Assert.AreEqual(["del."; "B"; "("; "In"; "("; "undef"; ")"; ")"], base1.TypeSignature)
            | "base5" -> Assert.AreEqual(["del."; "Test"; "("; ")"], base1.TypeSignature)
            | "base6" -> Assert.AreEqual(["del."; "C"; "("; "Test1"; "("; "undef"; ")"; "Test2"; "("; "undef"; "undef"; "undef"; ")"; ")"], base1.TypeSignature)
            | "base7" -> Assert.AreEqual(["del."; "E"; "("; "pred"; "undef"; "pred"; ")"], base1.TypeSignature)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            match var with
            | "base1" -> Assert.AreEqual(["T1"; "("; ")"], base1.TypeSignature)
            | "base2" -> Assert.AreEqual(["T1"; "("; ")"], base1.TypeSignature)
            | "base3" -> Assert.AreEqual(["T1"; "("; ")"], base1.TypeSignature)
            | "base4" -> Assert.AreEqual(["T1"; "("; ")"], base1.TypeSignature)
            | "base5" -> Assert.AreEqual(["T1"], base1.TypeSignature)
            | "base5a" -> Assert.AreEqual(["T1"], base1.TypeSignature)
            | "base6" -> Assert.AreEqual(["T1"; "("; ")"; "->"; "obj"], base1.TypeSignature)
            | "base7" -> Assert.AreEqual(["T1"; "("; ")"; "->"; "obj"], base1.TypeSignature)
            | "base8" -> Assert.AreEqual(["T1"; "("; ")"; "->"; "obj"], base1.TypeSignature)
            | "base9" -> Assert.AreEqual(["T1"; "("; ")"; "->"; "obj"], base1.TypeSignature)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
