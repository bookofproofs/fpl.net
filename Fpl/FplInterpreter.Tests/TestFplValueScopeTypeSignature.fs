...
type TestFplValueScopeTypeSignature() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base21" -> Assert.AreEqual<string>("and(undef, undefundef)", base1.Type(SignatureType.Type))
            ...
            | "base22" -> Assert.AreEqual<string>("xor(undef, undefundef)", base1.Type(SignatureType.Type))
            | "base23" -> Assert.AreEqual<string>("or(undef, undefundef)", base1.Type(SignatureType.Type))
            | "base24" -> Assert.AreEqual<string>("iif(undef, undef)", base1.Type(SignatureType.Type))
            | "base25" -> Assert.AreEqual<string>("impl(undef, undef)", base1.Type(SignatureType.Type))
            ...
            | "base28" -> Assert.AreEqual<string>("C(undef, undefundef, undef)", base1.Type(SignatureType.Type))
            | "base29" -> Assert.AreEqual<string>("D(selfundef, undef)", base1.Type(SignatureType.Type))
            | "base30" -> Assert.AreEqual<string>("B(In(undef))", base1.Type(SignatureType.Type))
            | "base31" -> Assert.AreEqual<string>("C(Test1(undef)Test2(undef, undefundef))", base1.Type(SignatureType.Type))
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base2" -> Assert.AreEqual<string>("del.C(undef, undefundef, undef)", base1.Type(SignatureType.Type))
            ...
            | "base5" -> Assert.AreEqual<string>("del.Test()", base1.Type(SignatureType.Type))
            | "base6" -> Assert.AreEqual<string>("del.C(Test1(undef)Test2(undef, undefundef))", base1.Type(SignatureType.Type))
