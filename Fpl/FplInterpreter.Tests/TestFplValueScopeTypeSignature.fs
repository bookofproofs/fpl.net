...
type TestFplValueScopeTypeSignature() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue,loc1:FplValue,loc2:FplValue) -> 
            ...
            | "cor1" -> Assert.AreEqual<string list>(["SomeLemma1$1"; "("; ")"], cor1.TypeSignature)
            | "cor2" -> Assert.AreEqual<string list>(["SomeLemma2$1"; "("; ")"], cor2.TypeSignature)
            ...
            | "prf1" -> Assert.AreEqual<string list>(["SomeTheorem1$1"], prf1.TypeSignature)
            | "prf2" -> Assert.AreEqual<string list>(["SomeTheorem2$1"], prf2.TypeSignature)
    ...
    member this.TestProofsAndCorollaries(var) =
        ...
        | Some (r,theory,thm1,proofThm1,lem1,proofLem1,prp1,proofPrp1,cor1,proofCor1,thm2,
                ...
                | "proofThm1" -> Assert.AreEqual<string list>(["TestTheorem1$1"], proofThm1.TypeSignature)
                | "lem1" -> Assert.AreEqual<string list>(["TestLemma1"; "("; ")"], lem1.TypeSignature)
                | "proofLem1" -> Assert.AreEqual<string list>(["TestLemma1$1"], proofLem1.TypeSignature)
                | "prp1" -> Assert.AreEqual<string list>(["TestProposition1"; "("; ")"], prp1.TypeSignature)
                | "proofPrp1" -> Assert.AreEqual<string list>(["TestProposition1$1"], proofPrp1.TypeSignature)
                | "cor1" -> Assert.AreEqual<string list>(["TestCorollary1$2"; "("; ")"], cor1.TypeSignature)
                | "proofCor1" -> Assert.AreEqual<string list>(["TestCorollary1$2$1"], proofCor1.TypeSignature)
                | "thm2" -> Assert.AreEqual<string list>(["TestTheorem2"; "("; ")"], thm2.TypeSignature)
                | "corThm2" -> Assert.AreEqual<string list>(["TestTheorem2$1"; "("; ")"], corThm2.TypeSignature)
                | "lem2" -> Assert.AreEqual<string list>(["TestLemma2"; "("; ")"], lem2.TypeSignature)
                | "corLem2" -> Assert.AreEqual<string list>(["TestLemma2$1"; "("; ")"], corLem2.TypeSignature)
                | "prp2" -> Assert.AreEqual<string list>(["TestProposition2"; "("; ")"], prp2.TypeSignature)
                | "corPrp2" -> Assert.AreEqual<string list>(["TestProposition2$1"; "("; ")"], corPrp2.TypeSignature)
                | "cor2" -> Assert.AreEqual<string list>(["TestCorollary2$2"; "("; ")"], cor2.TypeSignature)
                | "corCor2" -> Assert.AreEqual<string list>(["TestCorollary2$2$1"; "("; ")"], corCor2.TypeSignature)
                | "con1" -> Assert.AreEqual<string list>(["TestConjecture"; "("; ")"], con1.TypeSignature)
                | "corCon1" -> Assert.AreEqual<string list>(["TestConjecture$1"; "("; ")"], corCon1.TypeSignature)
                | "axi1" -> Assert.AreEqual<string list>(["TestAxiom"; "("; ")"], axi1.TypeSignature)
                | "corAxi1"  -> Assert.AreEqual<string list>(["TestAxiom$1"; "("; ")"], corAxi1.TypeSignature) 
                | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
