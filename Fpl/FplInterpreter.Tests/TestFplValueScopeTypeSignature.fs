...
type TestFplValueScopeTypeSignature() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base10e" -> Assert.AreEqual<string>("undef[undef, undef]", base1.Type SignatureType.Type)
            | "base11e" -> Assert.AreEqual<string>("undef[undef, undef]", base1.Type SignatureType.Type)
            | "base12e" -> Assert.AreEqual<string>("3[undef, undef]", base1.Type SignatureType.Type)
            | "base13e" -> Assert.AreEqual<string>("T[undef, undef]", base1.Type SignatureType.Type)
            | "base10f" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Type SignatureType.Type)
            | "base11f" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Type SignatureType.Type)
            | "base12f" -> Assert.AreEqual<string>("undef(undef, undef)", base1.Type SignatureType.Type)
            | "base13f" -> Assert.AreEqual<string>("T(undef, undef)", base1.Type SignatureType.Type)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base6" -> Assert.AreEqual<string>("C(Test1(undef), Test2(undef, undef, undef))", base1.Type(SignatureType.Mixed))
