...
type TestFplValueScopeTypeSignature() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base12e" -> Assert.AreEqual<string>("parent(undef, undef).obj[undef, undef]", base1.Type(SignatureType.Type))
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base3" -> Assert.AreEqual<string>("D(parent, undef, undef)", base1.Type(SignatureType.Mixed))
