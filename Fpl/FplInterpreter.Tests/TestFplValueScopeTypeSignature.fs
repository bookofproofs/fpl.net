...
type TestFplValueScopeTypeSignature() =
    ...
    member this.TestBlocks(var) =
        ...
        | Some (r:FplValue,theory:FplValue,inf1:FplValue,inf2:FplValue,axi1:FplValue,axi2:FplValue,pst1:FplValue,pst2:FplValue,thm1:FplValue,thm2:FplValue,pro1:FplValue,pro2:FplValue,lem1:FplValue,lem2:FplValue,cor1:FplValue,cor2:FplValue,con1:FplValue,con2:FplValue,cla1:FplValue,cla2:FplValue,pre1:FplValue,pre2:FplValue,fun1:FplValue,fun2:FplValue,prf1:FplValue,prf2:FplValue,loc1:FplValue,loc2:FplValue) -> 
            ...
            | "theory" -> Assert.AreEqual<string>("", theory.Type(SignatureType.Type))
            ...
            | "loc2" -> Assert.AreEqual<string>("Equal(undefundef)", loc2.Type(SignatureType.Type))
    ...
    member this.TestVariablesInBlock(var) =
        ...
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "x" -> Assert.AreEqual<string>("pred(func(objobjobj)->objfunc(objobjobj)->objfunc(objobjobj)->obj)", x.Type(SignatureType.Type))
            | "y" -> Assert.AreEqual<string>("pred(func(objobjobj)->objfunc(objobjobj)->objfunc(objobjobj)->obj)", y.Type(SignatureType.Type))
            | "s" -> Assert.AreEqual<string>("Set", s.Type(SignatureType.Type))
            | "xu" -> Assert.AreEqual<string>("func(objobjobj)->obj", xu.Type(SignatureType.Type))
            | "xv" -> Assert.AreEqual<string>("func(objobjobj)->obj", xv.Type(SignatureType.Type))
            | "xw" -> Assert.AreEqual<string>("func(objobjobj)->obj", xw.Type(SignatureType.Type))
            | "yu" -> Assert.AreEqual<string>("func(objobjobj)->obj", yu.Type(SignatureType.Type))
            | "yv" -> Assert.AreEqual<string>("func(objobjobj)->obj", yv.Type(SignatureType.Type))
            | "yw" -> Assert.AreEqual<string>("func(objobjobj)->obj", yw.Type(SignatureType.Type))
    ...
    member this.TestVariablesInBlockVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "theory" -> Assert.AreEqual<string>("", theory.Type(SignatureType.Type))
            | "block" -> Assert.AreEqual<string>("TestPredicate()", block.Type(SignatureType.Type)); 
            | "x" -> Assert.AreEqual<string>("+pred(func(*obj*obj*obj)->objfunc(*obj*obj*obj)->objfunc(*obj*obj*obj)->obj)", x.Type(SignatureType.Type))
            | "y" -> Assert.AreEqual<string>("+pred(func(*obj*obj*obj)->objfunc(*obj*obj*obj)->objfunc(*obj*obj*obj)->obj)", y.Type(SignatureType.Type))
    ...
    member this.TestVariablesInSignature(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Type))
            | "theory" -> Assert.AreEqual<string>("", theory.Type(SignatureType.Type))
            | "block" -> Assert.AreEqual<string>("TestPredicate(pred(func(objobjobj)->objfunc(objobjobj)->objfunc(objobjobj)->obj)pred(func(objobjobj)->objfunc(objobjobj)->objfunc(objobjobj)->obj))", block.Type(SignatureType.Type))
            | "x" -> Assert.AreEqual<string>("pred(func(objobjobj)->objfunc(objobjobj)->objfunc(objobjobj)->obj)", x.Type(SignatureType.Type))
            | "y" -> Assert.AreEqual<string>("pred(func(objobjobj)->objfunc(objobjobj)->objfunc(objobjobj)->obj)", y.Type(SignatureType.Type))
            | "xu" -> Assert.AreEqual<string>("func(objobjobj)->obj", xu.Type(SignatureType.Type))
            | "xv" -> Assert.AreEqual<string>("func(objobjobj)->obj", xv.Type(SignatureType.Type))
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        ...
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "r" -> Assert.AreEqual<string>("", r.Type(SignatureType.Type))
            | "theory" -> Assert.AreEqual<string>("", theory.Type(SignatureType.Type))
            | "block" -> Assert.AreEqual<string>("TestPredicate(+pred(func(*obj*obj*obj)->objfunc(*obj*obj*obj)->objfunc(*obj*obj*obj)->obj)+pred(func(*obj*obj*obj)->objfunc(*obj*obj*obj)->objfunc(*obj*obj*obj)->obj))", block.Type(SignatureType.Type)); 
            | "x" -> Assert.AreEqual<string>("+pred(func(*obj*obj*obj)->objfunc(*obj*obj*obj)->objfunc(*obj*obj*obj)->obj)", x.Type(SignatureType.Type))
            | "y" -> Assert.AreEqual<string>("+pred(func(*obj*obj*obj)->objfunc(*obj*obj*obj)->objfunc(*obj*obj*obj)->obj)", y.Type(SignatureType.Type))
            | "xu" -> Assert.AreEqual<string>("func(*obj*obj*obj)->obj", xu.Type(SignatureType.Type))
            | "xv" -> Assert.AreEqual<string>("func(*obj*obj*obj)->obj", xv.Type(SignatureType.Type))
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base10c" -> Assert.AreEqual<string>("Test(undefundef)", base1.Type(SignatureType.Type))
            | "base11c" -> Assert.AreEqual<string>("undef(undefundef)", base1.Type(SignatureType.Type))
            | "base12c" -> Assert.AreEqual<string>("self(undefundef)", base1.Type(SignatureType.Type))
            | "base13c" -> Assert.AreEqual<string>("1(undefundef)", base1.Type(SignatureType.Type))
            | "base10d" -> Assert.AreEqual<string>("Test[undefundef]", base1.Type(SignatureType.Type))
            | "base11d" -> Assert.AreEqual<string>("undef[undefundef]", base1.Type(SignatureType.Type))
            | "base12d" -> Assert.AreEqual<string>("self[undefundef]", base1.Type(SignatureType.Type))
            | "base13d" -> Assert.AreEqual<string>("1[undef.undef]", base1.Type(SignatureType.Type))
            | "base10e" -> Assert.AreEqual<string>("Test(undefundef).@self[undefundef]", base1.Type(SignatureType.Type))
            | "base11e" -> Assert.AreEqual<string>("undef(undefundef).undef[undefundef]", base1.Type(SignatureType.Type))
            | "base12e" -> Assert.AreEqual<string>("self(undefundef).3[undefundef]", base1.Type(SignatureType.Type))
            | "base13e" -> Assert.AreEqual<string>("1(undefundef).T[undefundef]", base1.Type(SignatureType.Type))
            | "base10f" -> Assert.AreEqual<string>("Test[undefundef].undef(undefundef)", base1.Type(SignatureType.Type))
            | "base11f" -> Assert.AreEqual<string>("undef[undefundef].undef(undefundef)", base1.Type(SignatureType.Type))
            | "base12f" -> Assert.AreEqual<string>("self[undefundef].self(undefundef)", base1.Type(SignatureType.Type))
            | "base13f" -> Assert.AreEqual<string>("1[undef.undef].T(undefundef)", base1.Type(SignatureType.Type))
            ...
            | "base16" -> Assert.AreEqual<string>("-(+(undef=(undef*(2undef))))", base1.Type(SignatureType.Type))
            | "base17" -> Assert.AreEqual<string>("'(+(undef=('(undef)*(2undef))))", base1.Type(SignatureType.Type))
            ...
            | "base21" -> Assert.AreEqual<string>("and(undefundefundef)", base1.Type(SignatureType.Type))
            | "base21a" -> Assert.AreEqual<string>("not(undef)", base1.Type(SignatureType.Type))
            | "base21b" -> Assert.AreEqual<string>("not(undef)", base1.Type(SignatureType.Type))
            | "base22" -> Assert.AreEqual<string>("xor(undefundefundef)", base1.Type(SignatureType.Type))
            | "base23" -> Assert.AreEqual<string>("or(undefundefundef)", base1.Type(SignatureType.Type))
            | "base24" -> Assert.AreEqual<string>("iif(undefundef)", base1.Type(SignatureType.Type))
            | "base25" -> Assert.AreEqual<string>("impl(undefundef)", base1.Type(SignatureType.Type))
            | "base26" -> Assert.AreEqual<string>("is(undefNat)", base1.Type(SignatureType.Type))
            | "base27" -> Assert.AreEqual<string>("B()", base1.Type(SignatureType.Type))
            | "base28" -> Assert.AreEqual<string>("C(undefundefundefundef)", base1.Type(SignatureType.Type))
            | "base29" -> Assert.AreEqual<string>("D(selfundefundef)", base1.Type(SignatureType.Type))
            | "base30" -> Assert.AreEqual<string>("B(In(undef))", base1.Type(SignatureType.Type))
            | "base31" -> Assert.AreEqual<string>("C(Test1(undef)Test2(undefundefundef))", base1.Type(SignatureType.Type))
            | "base32" -> Assert.AreEqual<string>("E(predundefpred)", base1.Type(SignatureType.Type))
            | "base33" -> Assert.AreEqual<string>("pred(obj)", base1.Type(SignatureType.Type))
            | "base34" -> Assert.AreEqual<string>("is(undefSet)", base1.Type(SignatureType.Type))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestCallConstructorParentClass(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base6" -> Assert.AreEqual<string>("E(predundefpred)", base1.Type(SignatureType.Type))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestDelegate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base2" -> Assert.AreEqual<string>("del.C(undefundefundefundef)", base1.Type(SignatureType.Type))
            | "base3" -> Assert.AreEqual<string>("del.D(selfundefundef)", base1.Type(SignatureType.Type))
            | "base4" -> Assert.AreEqual<string>("del.B(In(undef))", base1.Type(SignatureType.Type))
            | "base5" -> Assert.AreEqual<string>("del.Test()", base1.Type(SignatureType.Type))
            | "base6" -> Assert.AreEqual<string>("del.C(Test1(undef)Test2(undefundefundef))", base1.Type(SignatureType.Type))
            | "base7" -> Assert.AreEqual<string>("del.E(predundefpred)", base1.Type(SignatureType.Type))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
