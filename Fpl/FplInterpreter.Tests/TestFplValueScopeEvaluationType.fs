...
type TestFplValueScopeEvaluationType() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base2" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base3" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base4" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base5" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base6" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base7" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base8" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base9" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base10" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base13" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11a" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12a" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base10b" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11b" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12b" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base13b" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base10c" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11c" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12c" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base13c" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base10d" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11d" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12d" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base13d" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base10e" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11e" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12e" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base13e" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base10f" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base11f" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base12f" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            ...
            | "base25" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base26" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base27" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base28" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base29" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base30" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base31" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base32" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base4" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base5" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base5a" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base6" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base7" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base8" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
            | "base9" -> Assert.AreEqual(FplType.Object, base1.EvaluationType)
