...
type TestFplValueScopeQualifiedStartPos() =
    ...
    member this.TestProperties(var) =
        ...
        | Some (r:FplRoot,theory:FplValue,block:FplValue,t1:FplValue,t3:FplValue,t5:FplValue,t7:FplValue,t9:FplValue,t11:FplValue,t13:FplValue) -> 
            ...
            | PrimTheoryL -> Assert.IsTrue((theory.QualifiedStartPos).Contains("Ln: 1, Col: 1)"))
            | "block" -> Assert.IsTrue((block.QualifiedStartPos).Contains("Ln: 2, Col: 13)"))
            | "t1" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 5, Col: 13)", t1.QualifiedStartPos)
            | "t3" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 6, Col: 13)", t3.QualifiedStartPos)
            | "t5" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 7, Col: 13)", t5.QualifiedStartPos)
            | "t7" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 8, Col: 13)", t7.QualifiedStartPos)
            | "t9" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 9, Col: 13)", t9.QualifiedStartPos)
            | "t11" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 10, Col: 13)", t11.QualifiedStartPos)
            | "t13" -> Assert.AreEqual<string>("TestScopePropertiesQualifiedStartPos(Ln: 11, Col: 13)", t13.QualifiedStartPos)
            | _ -> Assert.IsTrue(false)
        | _ -> 
            Assert.IsTrue(false)
