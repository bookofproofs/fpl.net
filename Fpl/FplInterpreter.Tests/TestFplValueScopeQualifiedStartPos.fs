...
type TestFplValueScopeQualifiedStartPos() =
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base2" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base3" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base4" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base5" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base6" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base7" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base8" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base9" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base10" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base13" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11a" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12a" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base10b" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11b" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12b" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base13b" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base10c" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11c" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12c" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base13c" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base10d" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11d" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12d" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base13d" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base10e" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11e" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12e" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base13e" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base10f" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base11f" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base12f" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            ...
            | "base25" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base26" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base27" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base28" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base29" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base30" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base31" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base32" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | _ -> Assert.IsTrue(false)
        | None -> 
            Assert.IsTrue(false)
    ...
    member this.TestFixNotation(var, varVal) =
        ...
        | Some st -> 
            ...
            | "base4" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base5" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base5a" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base6" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base7" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base8" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
            | "base9" -> Assert.IsTrue(base1.QualifiedStartPos.ToString().Contains("Ln: 1, Col: 1)"))
