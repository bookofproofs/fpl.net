...
type TestProofs () =
    ...
    member this.TestJustification01 () =
        ...
        let expected = """Success: Justification [PredicateWithoutArgs (AliasedId ["GreaterAB"])]""".Replace("\r","")
  ...
  [ArgumentIdentifier "3.";
   PredicateWithoutArgs (AliasedId ["GreaterTransitive"])]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestJustification05 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Justification
  [ArgumentIdentifier "4."; PredicateWithoutArgs (AliasedId ["ModusPonens"])]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  [ArgumentIdentifier "4."; PredicateWithoutArgs (AliasedId ["ModusPonens"]);
   ArgumentIdentifier "1."]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  [ArgumentIdentifier "6.";
   PredicateWithArgs
     (AliasedId ["ExistsByExample"],
      [And
         [PredicateWithArgs
          ...
          PredicateWithArgs
            (AliasedId ["Greater"],
             [PredicateWithoutArgs (Var "a"); PredicateWithoutArgs (Var "b")])]])]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestJustification08 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Justification []""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestJustification09 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Justification
  [And [PredicateWithoutArgs (Var "a"); PredicateWithoutArgs (Var "b")]]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  [And [PredicateWithoutArgs (Var "a"); PredicateWithoutArgs (Var "b")];
   ArgumentIdentifier "2."]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  [Or [ArgumentIdentifier "1."; ArgumentIdentifier "2."];
   ArgumentIdentifier "2."]""".Replace("\r","")
    ...
    member this.TestPremiseOrOtherPredicate01 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: PremiseReference""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestPremiseOrOtherPredicate03 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: And [PredicateWithoutArgs (Var "a"); PredicateWithoutArgs (Var "b")]""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestDerivedArgument01 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Qed""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestDerivedArgument02 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Trivial""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestDerivedArgument03 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: ConclusionReference""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  (And [PredicateWithoutArgs (Var "a"); PredicateWithoutArgs (Var "b")])""".Replace("\r","")
    ...
    member this.TestArgumentInference06 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: RevokeArgument (ArgumentIdentifier "2.")""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  (Justification [],
   DerivedPredicate
    ...
    member this.TestJustifiedArgument02 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: JustifiedArgument (Justification [], RevokeArgument (ArgumentIdentifier "2."))""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  (Justification
     [And [PredicateWithoutArgs (Var "a"); PredicateWithoutArgs (Var "b")]],
   RevokeArgument (ArgumentIdentifier "2."))""".Replace("\r","")
        Assert.AreEqual(expected, actual);
  ...
  (Justification
   ...
   RevokeArgument (ArgumentIdentifier "2."))""".Replace("\r","")
    ...
    member this.TestArgument04 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: JustifiedArgument (Justification [], Qed)""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestArgument05 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: JustifiedArgument (Justification [], Trivial)""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestArgument06 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: JustifiedArgument
  (Justification [ArgumentIdentifier "2."; ArgumentIdentifier "3."], Trivial)""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestProof01 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Proof
  ((AliasedId ["Example4"], ["1"]),
   ([],
    [Argument
     ...
     Argument
       (ArgumentIdentifier "2.", JustifiedArgument (Justification [], Qed))]))""".Replace("\r","")
        Assert.AreEqual(expected, actual);
    ...
    member this.TestProof02 () =
        ...
        let actual = sprintf "%O" result
        let expected = """Success: Proof
  ((AliasedId ["AddIsUnique"], ["1"]),
   ([],
    [Argument (ArgumentIdentifier "1.", AssumeArgument PremiseReference);
     Argument
       (ArgumentIdentifier "2.", JustifiedArgument (Justification [], Trivial))]))""".Replace("\r","")
        Assert.AreEqual(expected, actual);
