...
type TestCoordPossibilities () =
    ...
    member this.TestPascalCaseId () =
        let result = run coord """PascalCaseId"""
        let actual = sprintf "%O" result
        printf "%O" actual
    ...
    member this.TestPascalCaseId2 () =
        let result = run coord """PascalCaseId.PascalCaseId()"""
        let actual = sprintf "%O" result
        printf "%O" actual
        Assert.IsTrue(actual.StartsWith("Success:"))
    ...
    member this.TestPascalCaseId3 () =
        let result = run coord """PascalCaseId.PascalCaseId().PascalCaseId()"""
        let actual = sprintf "%O" result
        printf "%O" actual
        Assert.IsTrue(actual.StartsWith("Success:"))
