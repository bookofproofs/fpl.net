...
type TestVariableTypes () =
    ...
    [<DataRow("*function(a,b:obj)->* pred [ind] [obj]")>]
    [<DataRow("*function(a,b:obj)->pred[tpl]")>]
    [<DataRow("func(a:ind,b:pred)->func")>]
    [<DataRow("func(a:ind,b:pred)->func(x,y:obj)->obj")>]
    [<DataRow("predicate()")>]
    [<DataRow("function()->obj")>]
    [<DataRow("*predicate()[Nat]")>]
    [<DataRow("pred(x:ind)")>]
    [<DataRow("*pred(x:ind)[ ind ,ind]")>]
    [<DataRow("pred(x , y, z:obj)")>]
    [<DataRow("*pred(x , y, z:obj) [ obj]")>]
    [<DataRow("index")>]
    [<DataRow("ind")>]
    [<DataRow("*ind[ind]")>]
    [<DataRow("template")>]
