...
open Fpl2Interpreter.Helpers.Checks
...
type QualifiedName() =
    ...
    member this.TestBlocks(var) =
        let res = TestCases.ScopeBlocks("QualifiedName") 
        match res with
        | Some (r:FplRoot,theory:FplGenericNode,inf1:FplGenericNode,inf2:FplGenericNode,axi1:FplGenericNode,axi2:FplGenericNode,pst1:FplGenericNode,pst2:FplGenericNode,thm1:FplGenericNode,thm2:FplGenericNode,pro1:FplGenericNode,pro2:FplGenericNode,lem1:FplGenericNode,lem2:FplGenericNode,cor1:FplGenericNode,cor2:FplGenericNode,con1:FplGenericNode,con2:FplGenericNode,cla1:FplGenericNode,cla2:FplGenericNode,pre1:FplGenericNode,pre2:FplGenericNode,fun1:FplGenericNode,fun2:FplGenericNode,fun3:FplGenericNode,fun4:FplGenericNode,fun5:FplGenericNode,fun6:FplGenericNode,fun7:FplGenericNode,fun8:FplGenericNode,fun9:FplGenericNode,prf1:FplGenericNode,prf2:FplGenericNode,loc1:FplGenericNode,loc2:FplGenericNode) -> 
            ...
            | "cla1" -> Assert.AreEqual<string>("a class `TestScopeBlocksQualifiedName.SomeClass1`", qualifiedName cla1 false) 
            | "cla2" -> Assert.AreEqual<string>("a class `TestScopeBlocksQualifiedName.SomeClass2`", qualifiedName cla2 false) 
            | "pre1" -> Assert.AreEqual<string>("a predicate `TestScopeBlocksQualifiedName.SomePredicate1()`", qualifiedName pre1 false)
            | "pre2" -> Assert.AreEqual<string>("a predicate `TestScopeBlocksQualifiedName.SomePredicate2()`", qualifiedName pre2 false)
            | "fun1" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm1() -> obj`", qualifiedName fun1 false)
            | "fun2" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm2() -> obj`", qualifiedName fun2 false)
            | "fun3" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm3() -> obj`", qualifiedName fun3 false)
            | "fun4" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm4() -> tpl`", qualifiedName fun4 false) 
            | "fun5" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm5() -> SomeClass1`", qualifiedName fun5 false)
            | "fun6" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm6() -> SomeClass1`", qualifiedName fun6 false)
            | "fun7" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm7() -> SomeClass1`", qualifiedName fun7 false)
            | "fun8" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm8() -> ind`", qualifiedName fun8 false)
            | "fun9" -> Assert.AreEqual<string>("a functional term `TestScopeBlocksQualifiedName.SomeFunctionalTerm9() -> ind`", qualifiedName fun9 false)
    ...
    member this.TestConstructors(var) =
        let res = TestCases.ScopeConstructors("QualifiedName") 
        match res with
        | Some (r:FplRoot,theory:FplGenericNode,block:FplGenericNode,t1:FplGenericNode,t2:FplGenericNode,t3:FplGenericNode,t4:FplGenericNode) -> 
            ...
            | "block" -> Assert.AreEqual<string>("a class `TestScopeConstructorsQualifiedName.TestId`", qualifiedName block false) 
    ...
    member this.TestProofsAndCorollaries(var) =
        let res = TestCases.ScopeProofsAndCorollaries("QualifiedName") 
        match res with
    ...
    member this.TestProperties(var) =
        let res = TestCases.ScopeProperties("QualifiedName") 
        match res with
        | Some (r:FplRoot,theory:FplGenericNode,block:FplGenericNode,t1:FplGenericNode,t3:FplGenericNode,t5:FplGenericNode,t7:FplGenericNode,t9:FplGenericNode,t11:FplGenericNode,t13:FplGenericNode) -> 
            ...
            | "block" -> Assert.AreEqual<string>("a predicate `TestScopePropertiesQualifiedName.TestId()`", qualifiedName block false) 
    ...
    member this.TestVariablesInBlock(var) =
        let result = TestCases.ScopeVariablesInBlock("QualifiedName")
        match result with
        | Some (r,theory,block,x,y,s,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "block" -> Assert.AreEqual<string>("a predicate `TestScopeVariablesInBlockQualifiedName.TestPredicate()`", qualifiedName block false) 
    ...
    member this.TestVariablesInBlockVariadic(var) =
        let result = TestCases.ScopeVariablesInBlockVariadic("QualifiedName")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            ...
            | "block" -> Assert.AreEqual<string>("a predicate `TestScopeVariablesInBlockVariadicQualifiedName.TestPredicate()`", qualifiedName block false) 
    ...
    member this.TestVariablesInSignature(var) =
        let result = TestCases.ScopeVariablesInSignature("QualifiedName")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with
            | "r" -> Assert.AreEqual<string>("a root ``", qualifiedName r false) 
            | PrimTheoryL -> Assert.AreEqual<string>("a theory `TestScopeVariablesInSignatureQualifiedName`", qualifiedName theory false) 
            | "block" -> Assert.AreEqual<string>("a predicate `TestScopeVariablesInSignatureQualifiedName.TestPredicate(pred(func(obj, obj, obj) -> obj, func(obj, obj, obj) -> obj, func(obj, obj, obj) -> obj), pred(func(obj, obj, obj) -> obj, func(obj, obj, obj) -> obj, func(obj, obj, obj) -> obj))`", qualifiedName block false) 
            | "x" -> Assert.AreEqual<string>("a variable `x`", qualifiedName x false) 
            | "y" -> Assert.AreEqual<string>("a variable `y`", qualifiedName y false) 
            | "xu" -> Assert.AreEqual<string>("a variable `x.u`", qualifiedName xu false) 
            | "xv" -> Assert.AreEqual<string>("a variable `x.v`", qualifiedName xv false) 
    ...
    member this.TestVariablesInSignatureVariadic(var) =
        let result = TestCases.ScopeVariablesInSignatureVariadic("QualifiedName")
        match result with
        | Some (r,theory,block,x,y,xw,xu,xv,yw,yu,yv,xwa,xwb,xwc,xua,xub,xuc,xva,xvb,xvc,ywa,ywb,ywc,yua,yub,yuc,yva,yvb,yvc) ->
            match var with
            | "r" -> Assert.AreEqual<string>("a root ``", qualifiedName r false) 
            ...
            | "block" -> Assert.AreEqual<string>("a predicate `TestScopeVariablesInSignatureVariadicQualifiedName.TestPredicate(*pred(func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj)[obj], *pred(func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj, func(*obj[ind], *obj[ind], *obj[ind]) -> obj)[obj])`", qualifiedName block false) 
            | "x" -> Assert.AreEqual<string>("a variable array `x`", qualifiedName x false) 
            | "y" -> Assert.AreEqual<string>("a variable array `y`", qualifiedName y false) 
            | "xu" -> Assert.AreEqual<string>("a variable `x.u`", qualifiedName xu false) 
            | "xv" -> Assert.AreEqual<string>("a variable `x.v`", qualifiedName xv false) 
    ...
    member this.TestPredicate(var, varVal) =
        ...
        | "base18" -> Assert.AreEqual<string>("an `exists` quantifier `TestPredicateQualifiedName.T1().∃ y:C, z:obj, x:pred(T) {a ∧ (b ∧ c)}`", qualifiedName base1 false) 
        | "base19" -> Assert.AreEqual<string>("an `exists n times` quantifier `TestPredicateQualifiedName.T1().∃! x:obj {∀ y:N {true}}`" , qualifiedName base1 false) 
        | "base20" -> Assert.AreEqual<string>("an `all` quantifier `TestPredicateQualifiedName.T1().∀ x:obj {¬x}`", qualifiedName base1 false) 
    ...
    member this.TestFixNotationQualifiedName(var, varVal) =
        ...
        match var with
        | "base1" -> Assert.AreEqual<string>("a predicate `TestFixNotationQualifiedName.T1()`", qualifiedName base1 false) 
        | "base2" -> Assert.AreEqual<string>("a predicate `TestFixNotationQualifiedName.T1()`", qualifiedName base1 false) 
        | "base3" -> Assert.AreEqual<string>("a predicate `TestFixNotationQualifiedName.T1()`", qualifiedName base1 false) 
        | "base4" -> Assert.AreEqual<string>("a predicate `TestFixNotationQualifiedName.T1()`", qualifiedName base1 false) 
        | "base5" -> Assert.AreEqual<string>("a class `TestFixNotationQualifiedName.T1`", qualifiedName base1 false) 
        | "base5a" -> Assert.AreEqual<string>("a class `TestFixNotationQualifiedName.T1`", qualifiedName base1 false) 
        | "base6" -> Assert.AreEqual<string>("a functional term `TestFixNotationQualifiedName.T1() -> obj`", qualifiedName base1 false) 
        | "base7" -> Assert.AreEqual<string>("a functional term `TestFixNotationQualifiedName.T1() -> obj`", qualifiedName base1 false) 
        | "base8" -> Assert.AreEqual<string>("a functional term `TestFixNotationQualifiedName.T1() -> obj`", qualifiedName base1 false) 
        | "base9" -> Assert.AreEqual<string>("a functional term `TestFixNotationQualifiedName.T1() -> obj`", qualifiedName base1 false) 
        | _ -> Assert.IsTrue(false)
        prepareFplCode(filename, "", false) |> ignore
