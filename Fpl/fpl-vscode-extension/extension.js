...
function dispatchRuntime(runtimeName) {
    if (runtimeName == 'win32-x64') {
        return ['https://download.visualstudio.microsoft.com/download/pr/8abf4502-4a22-4a2e-bea0-9fe73379d62e/88146c1d41e53e08f9dbc92a217143de', 'dotnet-runtime-8.0.2-win-x64.zip'];
    }
    else if (runtimeName == "linux-x64") {
        return ['https://download.visualstudio.microsoft.com/download/pr/307e4bf7-53c1-4b03-a2e5-379151ab3a04/140e7502609d45dfd83e4750b4bb5178', 'dotnet-runtime-8.0.2-linux-x64.tar.gz'];
    }
    else if (runtimeName == "darwin-x64") {
        return ['https://download.visualstudio.microsoft.com/download/pr/414af43f-fdc6-4e8e-bbff-8b544a6627a8/0719a2eafa1d0d5f73ee0a7aae4ce670', 'dotnet-runtime-8.0.2-osx-x64.tar.gz'];
    }
    else {
