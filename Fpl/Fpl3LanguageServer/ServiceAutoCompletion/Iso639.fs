...
module Fpl3LanguageServer.ServiceAutoCompletion.Iso639
...
/// <summary>
/// Completion-item choice provider for ISO 639-2 language codes.
/// </summary>
type FplCompletionItemChoicesIso639() =
    ...
    override this.GetChoices(defaultCi: FplCompletionItem) : List<FplCompletionItem> =
        ...
        for kvp in iso632_2 do
            let baseCi = FplCompletionItem(kvp.Key)
            let ci =
                baseCi
                    .WithInsertText(kvp.Key + ": ")
                    .WithLabel(FplCompletionItemChoices.TokenPrefix + kvp.Value + " ...")
