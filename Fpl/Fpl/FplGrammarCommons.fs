...
let recoveryMap = dict [
    ...
    ("'<', '@', 'all', 'and', 'dec', 'declaration', 'del', 'delegate', 'ex', 'false', 'iif', 'impl', 'intr', 'intrinsic', 'is', 'not', 'or', 'self', 'spec', 'specification', 'true', 'undef', 'undefined', 'xor', <PascalCaseId>, <argument identifier>, <block comment>, <digits>, <inline comment>, <significant whitespace>, <variable>", "true")
    ("'<', '@', 'all', 'and', 'dec', 'declaration', 'del', 'delegate', 'ex', 'false', 'iif', 'impl', 'is', 'not', 'or', 'self', 'spec', 'specification', 'true', 'undef', 'undefined', 'xor', <PascalCaseId>, <argument identifier>, <block comment>, <digits>, <inline comment>, <significant whitespace>, <variable (got keyword)>", "true")
    ("'<', '@', 'all', 'and', 'dec', 'declaration', 'del', 'delegate', 'ex', 'false', 'iif', 'impl', 'is', 'not', 'or', 'self', 'spec', 'specification', 'true', 'undef', 'undefined', 'xor', <PascalCaseId>, <argument identifier>, <block comment>, <digits>, <inline comment>, <significant whitespace>, <variable>, <whitespace>", "true")
    ("'<', '@', 'all', 'and', 'dec', 'declaration', 'del', 'delegate', 'ex', 'false', 'iif', 'impl', 'is', 'not', 'or', 'self', 'spec', 'specification', 'true', 'undef', 'undefined', 'xor', <PascalCaseId>, <argument identifier>, <block comment>, <digits>, <inline comment>, <significant whitespace>, <variable>", "true")
    ("'<', '@', 'all', 'and', 'del', 'delegate', 'ex', 'false', 'iif', 'impl', 'is', 'not', 'or', 'self', 'true', 'undef', 'undefined', 'xor', '}', <PascalCaseId>, <argument identifier>, <block comment>, <digits>, <inline comment>, <significant whitespace>, <variable>, <whitespace>", "}")
    ("'<', '@', 'all', 'and', 'del', 'delegate', 'ex', 'false', 'iif', 'impl', 'is', 'not', 'or', 'self', 'true', 'undef', 'undefined', 'xor', <PascalCaseId>, <argument identifier>, <block comment>, <digits>, <inline comment>, <significant whitespace>, <variable>", "true")
